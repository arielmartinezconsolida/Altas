!function (t, e) {
    ...
    var g = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
            ...
            for (var s in i) if (Object.prototype.hasOwnProperty.call(i, s)) {
                var n = i[s], o = e[s],
                    r = o && g.isElement(o) ? "element" : null == (a = o) ? "" + a : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    g.jQueryDetection(), f.fn.emulateTransitionEnd = i, f.event.special[g.TRANSITION_END] = {
        bindType: e,
        delegateType: e,
        handle: function (t) {
    ...
    var n = "alert", o = "bs.alert", a = f.fn[n], h = function () {
        function s(t) {
            this._element = t
        }
    ...
    f(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', h._handleDismiss(new h)), f.fn[n] = h._jQueryInterface, f.fn[n].Constructor = h, f.fn[n].noConflict = function () {
        return f.fn[n] = a, h._jQueryInterface
    };
    var c = "button", u = "bs.button", d = f.fn[c], p = "active", m = '[data-toggle^="button"]',
        v = 'input:not([type="hidden"])', _ = ".btn", b = function () {
            function i(t) {
                this._element = t
            }
    ...
    f(document).on("click.bs.button.data-api", m, function (t) {
        var e = t.target, i = e;
        if (f(e).hasClass("btn") || (e = f(e).closest(_)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault(); else {
            var s = e.querySelector(v);
            if (s && (s.hasAttribute("disabled") || s.classList.contains("disabled"))) return void t.preventDefault();
            ("LABEL" !== i.tagName || s && "checkbox" !== s.type) && b._jQueryInterface.call(f(e), "toggle")
        }
        ...
        for (var t = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), e = 0, i = t.length; e < i; e++) {
            var s = t[e], n = s.querySelector(v);
            n.checked || n.hasAttribute("checked") ? s.classList.add(p) : s.classList.remove(p)
        }
    ...
    }), f.fn[c] = b._jQueryInterface, f.fn[c].Constructor = b, f.fn[c].noConflict = function () {
        return f.fn[c] = d, b._jQueryInterface
    };
    var y = "carousel", w = "bs.carousel", C = "." + w, x = f.fn[y],
        k = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, D = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, E = "next", S = "prev", I = "slid" + C, T = "active", F = ".active.carousel-item",
        A = {TOUCH: "touch", PEN: "pen"}, P = function () {
            function o(t, e) {
            ...
            return t.next = function () {
                ...
                if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) f(this._element).one(I, function () {
                    return e.to(t)
                }); else {
                ...
                f(this._element).off(C), f.removeData(this._element, w), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, t._getConfig = function (t) {
                return t = l({}, k, t), g.typeCheckConfig(y, t, D), t
                ...
                var i = t === E, s = t === S, n = this._getItemIndex(e), o = this._items.length - 1;
                if ((s && 0 === n || i && n === o) && !this._config.wrap) return e;
                var r = (n + (t === S ? -1 : 1)) % this._items.length;
                return -1 == r ? this._items[this._items.length - 1] : this._items[r]
            }, t._triggerSlideEvent = function (t, e) {
                var i = this._getItemIndex(t), s = this._getItemIndex(this._element.querySelector(F)),
                    n = f.Event("slide.bs.carousel", {relatedTarget: t, direction: e, from: s, to: i});
                return f(this._element).trigger(n), n
            }, t._setActiveIndicatorElement = function (t) {
                var e, i;
                this._indicatorsElement && (e = [].slice.call(this._indicatorsElement.querySelectorAll(".active")), f(e).removeClass(T), (i = this._indicatorsElement.children[this._getItemIndex(t)]) && f(i).addClass(T))
            }, t._slide = function (t, e) {
                var i, s, n, o, r, a = this, l = this._element.querySelector(F), h = this._getItemIndex(l),
                    c = e || l && this._getItemByDirection(t, l), u = this._getItemIndex(c), d = Boolean(this._interval),
                    p = t === E ? (i = "carousel-item-left", s = "carousel-item-next", "left") : (i = "carousel-item-right", s = "carousel-item-prev", "right");
                c && f(c).hasClass(T) ? this._isSliding = !1 : this._triggerSlideEvent(c, p).isDefaultPrevented() || l && c && (this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(c), n = f.Event(I, {
                    relatedTarget: c,
                    direction: p,
                    from: h,
                    to: u
                }), f(this._element).hasClass("slide") ? (f(c).addClass(s), g.reflow(c), f(l).addClass(i), f(c).addClass(i), (o = parseInt(c.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = o) : this._config.interval = this._config.defaultInterval || this._config.interval, r = g.getTransitionDurationFromElement(l), f(l).one(g.TRANSITION_END, function () {
                    f(c).removeClass(i + " " + s).addClass(T), f(l).removeClass(T + " " + s + " " + i), a._isSliding = !1, setTimeout(function () {
                        return f(a._element).trigger(n)
                    }, 0)
                }).emulateTransitionEnd(r)) : (f(l).removeClass(T), f(c).addClass(T), this._isSliding = !1, f(this._element).trigger(n)), d && this.cycle())
            }, o._jQueryInterface = function (s) {
                return this.each(function () {
                    var t = f(this).data(w), e = l({}, k, f(this).data());
                    "object" == typeof s && (e = l({}, e, s));
                    var i = "string" == typeof s ? s : e.slide;
                    if (t || (t = new o(this, e), f(this).data(w, t)), "number" == typeof s) t.to(s); else if ("string" == typeof i) {
                ...
                !n || (e = f(n)[0]) && f(e).hasClass("carousel") && (i = l({}, f(e).data(), f(this).data()), (s = this.getAttribute("data-slide-to")) && (i.interval = !1), o._jQueryInterface.call(f(e), i), s && f(e).data(w).to(s), t.preventDefault())
            }, r(o, null, [{
                key: "VERSION", get: function () {
                    return "4.5.2"
                }
    ...
    f(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", P._dataApiClickHandler), f(window).on("load.bs.carousel.data-api", function () {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var s = f(t[e]);
            P._jQueryInterface.call(s, s.data())
        }
    }), f.fn[y] = P._jQueryInterface, f.fn[y].Constructor = P, f.fn[y].noConflict = function () {
        return f.fn[y] = x, P._jQueryInterface
    };
    var M = "collapse", N = "bs.collapse", O = f.fn[M], z = {toggle: !0, parent: ""},
        H = {toggle: "boolean", parent: "(string|element)"}, L = "show", R = "collapse", W = "collapsing",
        j = "collapsed", $ = '[data-toggle="collapse"]', q = function () {
            function a(e, t) {
                this._isTransitioning = !1, this._element = e, this._config = this._getConfig(t), this._triggerArray = [].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
                for (var i = [].slice.call(document.querySelectorAll($)), s = 0, n = i.length; s < n; s++) {
                    var o = i[s], r = g.getSelectorFromElement(o),
            ...
            var t = a.prototype;
            return t.toggle = function () {
                f(this._element).hasClass(L) ? this.hide() : this.show()
            }, t.show = function () {
                var t, e, i, s, n, o, r = this;
                this._isTransitioning || f(this._element).hasClass(L) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (t) {
                    return "string" == typeof r._config.parent ? t.getAttribute("data-parent") === r._config.parent : t.classList.contains(R)
                })).length && (t = null), t && (e = f(t).not(this._selector).data(N)) && e._isTransitioning || (i = f.Event("show.bs.collapse"), f(this._element).trigger(i), i.isDefaultPrevented() || (t && (a._jQueryInterface.call(f(t).not(this._selector), "hide"), e || f(t).data(N, null)), s = this._getDimension(), f(this._element).removeClass(R).addClass(W), this._element.style[s] = 0, this._triggerArray.length && f(this._triggerArray).removeClass(j).attr("aria-expanded", !0), this.setTransitioning(!0), n = "scroll" + (s[0].toUpperCase() + s.slice(1)), o = g.getTransitionDurationFromElement(this._element), f(this._element).one(g.TRANSITION_END, function () {
                    f(r._element).removeClass(W).addClass(R + " " + L), r._element.style[s] = "", r.setTransitioning(!1), f(r._element).trigger("shown.bs.collapse")
                }).emulateTransitionEnd(o), this._element.style[s] = this._element[n] + "px")))
            }, t.hide = function () {
                var t = this;
                if (!this._isTransitioning && f(this._element).hasClass(L)) {
                    var e = f.Event("hide.bs.collapse");
                    if (f(this._element).trigger(e), !e.isDefaultPrevented()) {
                        var i = this._getDimension();
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", g.reflow(this._element), f(this._element).addClass(W).removeClass(R + " " + L);
                        var s = this._triggerArray.length;
                        if (0 < s) for (var n = 0; n < s; n++) {
                            var o = this._triggerArray[n], r = g.getSelectorFromElement(o);
                            null !== r && (f([].slice.call(document.querySelectorAll(r))).hasClass(L) || f(o).addClass(j).attr("aria-expanded", !1))
                        }
                        this.setTransitioning(!0);
                        this._element.style[i] = "";
                        var a = g.getTransitionDurationFromElement(this._element);
                        f(this._element).one(g.TRANSITION_END, function () {
                            t.setTransitioning(!1), f(t._element).removeClass(W).addClass(R).trigger("hidden.bs.collapse")
                ...
                f.removeData(this._element, N), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, t._getConfig = function (t) {
                return (t = l({}, z, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(M, t, H), t
                ...
                return this.each(function () {
                    var t = f(this), e = t.data(N), i = l({}, z, t.data(), "object" == typeof s && s ? s : {});
                    if (!e && i.toggle && "string" == typeof s && /show|hide/.test(s) && (i.toggle = !1), e || (e = new a(this, i), t.data(N, e)), "string" == typeof s) {
    ...
    f(document).on("click.bs.collapse.data-api", $, function (t) {
        "A" === t.currentTarget.tagName && t.preventDefault();
        var i = f(this), e = g.getSelectorFromElement(this), s = [].slice.call(document.querySelectorAll(e));
        f(s).each(function () {
            var t = f(this), e = t.data(N) ? "toggle" : i.data();
            q._jQueryInterface.call(t, e)
        })
    }), f.fn[M] = q._jQueryInterface, f.fn[M].Constructor = q, f.fn[M].noConflict = function () {
        return f.fn[M] = O, q._jQueryInterface
    };
    ...
    var Q = B && window.Promise ? function (t) {
        var e = !1;
        return function () {
    ...
    function X(t) {
        ...
        var e = V(t), i = e.overflow, s = e.overflowX, n = e.overflowY;
        return /(auto|scroll|overlay)/.test(i + n + s) ? t : X(K(t))
    }
    ...
    var Z = B && !(!window.MSInputMethodContext || !document.documentMode),
        J = B && /MSIE 10/.test(navigator.userAgent);

    function tt(t) {
        return 11 === t ? Z : 10 !== t && Z || J
    }

    function et(t) {
        if (!t) return document.documentElement;
        for (var e = tt(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling;) i = (t = t.nextElementSibling).offsetParent;
        var s = i && i.nodeName;
        return s && "BODY" !== s && "HTML" !== s ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === V(i, "position") ? et(i) : i : t ? t.ownerDocument.documentElement : document.documentElement
    }
    ...
    function st(t, e) {
        ...
        if (t !== l && e !== l || s.contains(n)) return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && et(r.firstElementChild) !== r ? et(l) : l;
        var h = it(t);
        return h.host ? st(h.host, e) : st(t, it(e).host)
    }
    ...
    function ot(t, e) {
        ...
        return parseFloat(t["border" + i + "Width"]) + parseFloat(t["border" + s + "Width"])
    }

    function rt(t, e, i, s) {
        return Math.max(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], tt(10) ? parseInt(i["offset" + t]) + parseInt(s["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(s["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }

    function at(t) {
        var e = t.body, i = t.documentElement, s = tt(10) && getComputedStyle(i);
        return {height: rt("Height", e, i, s), width: rt("Width", e, i, s)}
    }
    ...
    function pt(t) {
        return dt({}, t, {right: t.left + t.width, bottom: t.top + t.height})
    }

    function ft(t) {
        var e, i, s = {};
        try {
            tt(10) ? (s = t.getBoundingClientRect(), e = nt(t, "top"), i = nt(t, "left"), s.top += e, s.left += i, s.bottom += e, s.right += i) : s = t.getBoundingClientRect()
        } catch (t) {
        }
        var n, o = {left: s.left, top: s.top, width: s.right - s.left, height: s.bottom - s.top},
            r = "HTML" === t.nodeName ? at(t.ownerDocument) : {}, a = r.width || t.clientWidth || o.width,
            l = r.height || t.clientHeight || o.height, h = t.offsetWidth - a, c = t.offsetHeight - l;
        return (h || c) && (h -= ot(n = V(t), "x"), c -= ot(n, "y"), o.width -= h, o.height -= c), pt(o)
    }

    function gt(t, e, i) {
        var s = 2 < arguments.length && void 0 !== i && i, n = tt(10), o = "HTML" === e.nodeName, r = ft(t), a = ft(e),
            l = X(t), h = V(e), c = parseFloat(h.borderTopWidth), u = parseFloat(h.borderLeftWidth);
        s && o && (a.top = Math.max(a.top, 0), a.left = Math.max(a.left, 0));
        var d, p, f = pt({top: r.top - a.top - c, left: r.left - a.left - u, width: r.width, height: r.height});
        return f.marginTop = 0, f.marginLeft = 0, !n && o && (d = parseFloat(h.marginTop), p = parseFloat(h.marginLeft), f.top -= c - d, f.bottom -= c - d, f.left -= u - p, f.right -= u - p, f.marginTop = d, f.marginLeft = p), (n && !s ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (f = function (t, e, i) {
            var s = 2 < arguments.length && void 0 !== i && i, n = nt(e, "top"), o = nt(e, "left"), r = s ? -1 : 1;
    ...
    function vt(t, e, i, s, n) {
        var o, r, a, l, h, c = 4 < arguments.length && void 0 !== n && n, u = {top: 0, left: 0},
            d = c ? mt(t) : st(t, G(e));
        "viewport" === s ? u = function (t, e) {
            var i = 1 < arguments.length && void 0 !== e && e, s = t.ownerDocument.documentElement, n = gt(t, s),
                o = Math.max(s.clientWidth, window.innerWidth || 0),
                r = Math.max(s.clientHeight, window.innerHeight || 0), a = i ? 0 : nt(s), l = i ? 0 : nt(s, "left");
            return pt({top: a - n.top + n.marginTop, left: l - n.left + n.marginLeft, width: o, height: r})
        }(d, c) : (o = void 0, "scrollParent" === s ? "BODY" === (o = X(K(e))).nodeName && (o = t.ownerDocument.documentElement) : o = "window" === s ? t.ownerDocument.documentElement : s, r = gt(o, d, c), "HTML" !== o.nodeName || function t(e) {
            var i = e.nodeName;
            if ("BODY" === i || "HTML" === i) return !1;
            if ("fixed" === V(e, "position")) return !0;
            var s = K(e);
            return !!s && t(s)
        }(d) ? u = r : (l = (a = at(t.ownerDocument)).height, h = a.width, u.top += r.top - r.marginTop, u.bottom = l + r.top, u.left += r.left - r.marginLeft, u.right = h + r.left));
        var p = "number" == typeof (i = i || 0);
        return u.left += p ? i : i.left || 0, u.top += p ? i : i.top || 0, u.right -= p ? i : i.right || 0, u.bottom -= p ? i : i.bottom || 0, u
    }

    function _t(t, e, s, i, n, o) {
        ...
        var a = vt(s, i, r, n), l = {
            ...
            return dt({key: t}, l[t], {area: (e = l[t]).width * e.height});
            var e
        }).sort(function (t, e) {
        ...
        }), u = 0 < c.length ? c[0].key : h[0].key, d = t.split("-")[1];
        return u + (d ? "-" + d : "")
    }

    function bt(t, e, i, s) {
        var n = 3 < arguments.length && void 0 !== s ? s : null;
        return gt(i, n ? mt(e) : st(e, G(i)), n)
    }
    ...
    function Ct(t, e, i) {
        i = i.split("-")[0];
        var s = yt(t), n = {width: s.width, height: s.height}, o = -1 !== ["right", "left"].indexOf(i),
            r = o ? "top" : "left", a = o ? "left" : "top", l = o ? "height" : "width", h = o ? "width" : "height";
        return n[r] = e[r] + e[l] / 2 - s[l] / 2, n[a] = i === a ? e[a] - s[h] : e[wt(a)], n
    }
    ...
    function kt(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function (t, e, i) {
            ...
            t.enabled && U(e) && (i.offsets.popper = pt(i.offsets.popper), i.offsets.reference = pt(i.offsets.reference), i = e(i, t))
        }), i
    }
    ...
    function It(t, e, i, s) {
        i.updateBound = s, St(t).addEventListener("resize", i.updateBound, {passive: !0});
        var n = X(t);
        return function t(e, i, s, n) {
            var o = "BODY" === e.nodeName, r = o ? e.ownerDocument.defaultView : e;
            r.addEventListener(i, s, {passive: !0}), o || t(X(r.parentNode), i, s, n), n.push(r)
        }(n, "scroll", i.updateBound, i.scrollParents), i.scrollElement = n, i.eventsEnabled = !0, i
    }

    function Tt() {
        var t, e;
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = (t = this.reference, e = this.state, St(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function (t) {
    ...
    function At(i, s) {
        Object.keys(s).forEach(function (t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && Ft(s[t]) && (e = "px"), i.style[t] = s[t] + e
        })
    }
    ...
    function Pt(t, e) {
        ...
        var s = t.offsets, n = s.popper, o = s.reference, r = Math.round, a = Math.floor, l = r(o.width),
            h = r(n.width), c = -1 !== ["left", "right"].indexOf(t.placement), u = -1 !== t.placement.indexOf("-"),
            d = e ? c || u || l % 2 == h % 2 ? r : a : i, p = e ? r : i;
        return {
    ...
    var Mt = B && /Firefox/i.test(navigator.userAgent);

    function Nt(t, e, i) {
        var s, n, o = xt(t, function (t) {
            return t.name === e
        }), r = !!o && t.some(function (t) {
            return t.name === i && t.enabled && t.order < o.order
        });
        return r || (s = "`" + e + "`", n = "`" + i + "`", console.warn(n + " modifier is required by " + s + " modifier in order to work, be sure to include it before " + s + "!")), r
    }

    var Ot = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"],
        zt = Ot.slice(3);

    function Ht(t, e) {
        var i = 1 < arguments.length && void 0 !== e && e, s = zt.indexOf(t),
            n = zt.slice(s + 1).concat(zt.slice(0, s));
        return i ? n.reverse() : n
    }

    var Lt = "flip", Rt = "clockwise", Wt = "counterclockwise";

    function jt(t, n, o, e) {
        var r = [0, 0], a = -1 !== ["right", "left"].indexOf(e), i = t.split(/(\+|\-)/).map(function (t) {
            return t.trim()
        }), s = i.indexOf(xt(i, function (t) {
            return -1 !== t.search(/,|\s/)
        }));
        ...
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (t) {
                    var e, i, s, n, o, r, a, l = t.placement, h = l.split("-")[0], c = l.split("-")[1];
                    return c && (i = (e = t.offsets).reference, s = e.popper, r = (n = -1 !== ["bottom", "top"].indexOf(h)) ? "width" : "height", a = {
                        start: ut({}, o = n ? "left" : "top", i[o]),
                        end: ut({}, o, i[o] + i[r] - s[r])
                    }, t.offsets.popper = dt({}, s, a[c])), t
                }
            }, offset: {
                order: 200, enabled: !0, fn: function (t, e) {
                    var i = e.offset, s = t.placement, n = t.offsets, o = n.popper, r = n.reference,
                        a = s.split("-")[0], l = void 0, l = Ft(+i) ? [+i, 0] : jt(i, o, r, a);
                ...
                order: 300, enabled: !0, fn: function (t, s) {
                    var e = s.boundariesElement || et(t.instance.popper);
                    t.instance.reference === e && (e = et(e));
                    var i = Et("transform"), n = t.instance.popper.style, o = n.top, r = n.left, a = n[i];
                    n.top = "", n.left = "", n[i] = "";
                    var l = vt(t.instance.popper, t.instance.reference, s.padding, e, t.positionFixed);
                    n.top = o, n.left = r, n[i] = a, s.boundaries = l;
                    var h = s.priority, c = t.offsets.popper, u = {
                        primary: function (t) {
                            var e = c[t];
                            return c[t] < l[t] && !s.escapeWithReference && (e = Math.max(c[t], l[t])), ut({}, t, e)
                        }, secondary: function (t) {
                            var e = "right" === t ? "left" : "top", i = c[e];
                            return c[t] > l[t] && !s.escapeWithReference && (i = Math.min(c[e], l[t] - ("right" === t ? c.width : c.height))), ut({}, e, i)
                        }
                    };
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var n = t.placement.split("-")[0], o = t.offsets, r = o.popper, a = o.reference,
                        ...
                        u = c.toLowerCase(), d = l ? "left" : "top", p = l ? "bottom" : "right", f = yt(s)[h];
                    a[p] - f < r[u] && (t.offsets.popper[u] -= r[u] - (a[p] - f)), a[u] + f > r[p] && (t.offsets.popper[u] += a[u] + f - r[p]), t.offsets.popper = pt(t.offsets.popper);
                    var g = a[u] + a[h] / 2 - f / 2, m = V(t.instance.popper), v = parseFloat(m["margin" + c]),
                        _ = parseFloat(m["border" + c + "Width"]), b = g - t.offsets.popper[u] - v - _,
                        b = Math.max(Math.min(r[h] - f, b), 0);
                    return t.arrowElement = s, t.offsets.arrow = (ut(i = {}, u, Math.round(b)), ut(i, d, ""), i), t
                }, element: "[x-arrow]"
            }, flip: {
                order: 600,
                enabled: !0,
                fn: function (m, v) {
                    ...
                    var _ = vt(m.instance.popper, m.instance.reference, v.padding, v.boundariesElement, m.positionFixed),
                        b = m.placement.split("-")[0], y = wt(b), w = m.placement.split("-")[1] || "", C = [];
                    switch (v.behavior) {
                        case Lt:
                            C = [b, y];
                            break;
                    ...
                    return C.forEach(function (t, e) {
                        ...
                        b = m.placement.split("-")[0], y = wt(b);
                        var i, s = m.offsets.popper, n = m.offsets.reference, o = Math.floor,
                            r = "left" === b && o(s.right) > o(n.left) || "right" === b && o(s.left) < o(n.right) || "top" === b && o(s.bottom) > o(n.top) || "bottom" === b && o(s.top) < o(n.bottom),
                            a = o(s.left) < o(_.left), l = o(s.right) > o(_.right), h = o(s.top) < o(_.top),
                            c = o(s.bottom) > o(_.bottom),
                            u = "left" === b && a || "right" === b && l || "top" === b && h || "bottom" === b && c,
                            d = -1 !== ["top", "bottom"].indexOf(b),
                            p = !!v.flipVariations && (d && "start" === w && a || d && "end" === w && l || !d && "start" === w && h || !d && "end" === w && c),
                            f = !!v.flipVariationsByContent && (d && "start" === w && l || d && "end" === w && a || !d && "start" === w && c || !d && "end" === w && h),
                            g = p || f;
                        (r || u || g) && (m.flipped = !0, (r || u) && (b = C[e + 1]), g && (w = "end" === (i = w) ? "start" : "start" === i ? "end" : i), m.placement = b + (w ? "-" + w : ""), m.offsets.popper = dt({}, m.offsets.popper, Ct(m.instance.popper, m.offsets.reference, m.placement)), m = kt(m.instance.modifiers, m, "flip"))
                    }), m
                },
                behavior: "flip",
                padding: 5,
                ...
                order: 700, enabled: !1, fn: function (t) {
                    ...
                    return n[r ? "left" : "top"] = o[i] - (a ? n[r ? "width" : "height"] : 0), t.placement = wt(e), t.offsets.popper = pt(n), t
                }
            }, hide: {
                order: 800, enabled: !0, fn: function (t) {
                    if (!Nt(t.instance.modifiers, "hide", "preventOverflow")) return t;
                    var e = t.offsets.reference, i = xt(t.instance.modifiers, function (t) {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var i = e.x, s = e.y, n = t.offsets.popper, o = xt(t.instance.modifiers, function (t) {
                        return "applyStyle" === t.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var r, a, l = void 0 !== o ? o : e.gpuAcceleration, h = et(t.instance.popper), c = ft(h),
                        u = {position: n.position}, d = Pt(t, window.devicePixelRatio < 2 || !Mt),
                        p = "bottom" === i ? "top" : "bottom", f = "right" === s ? "left" : "right",
                        g = Et("transform"), m = void 0, v = void 0,
                    ...
                    l && g ? (u[g] = "translate3d(" + m + "px, " + v + "px, 0)", u[p] = 0, u[f] = 0, u.willChange = "transform") : (r = "bottom" == p ? -1 : 1, a = "right" == f ? -1 : 1, u[p] = v * r, u[f] = m * a, u.willChange = p + ", " + f);
                    var _ = {"x-placement": t.placement};
                    return t.attributes = dt({}, _, t.attributes), t.styles = dt({}, u, t.styles), t.arrowStyles = dt({}, t.offsets.arrow, t.arrowStyles), t
                ...
                order: 900, enabled: !0, fn: function (t) {
                    ...
                    var o = bt(n, e, t, i.positionFixed),
                        r = _t(i.placement, o, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
                    return e.setAttribute("x-placement", r), At(e, {position: i.positionFixed ? "fixed" : "absolute"}), i
    ...
    function Bt(t, e) {
        ...
        lt(this, Bt), this.scheduleUpdate = function () {
            return requestAnimationFrame(i.update)
        }, this.update = Q(this.update.bind(this)), this.options = dt({}, Bt.Defaults, s), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(dt({}, Bt.Defaults.modifiers, s.modifiers)).forEach(function (t) {
            i.options.modifiers[t] = dt({}, Bt.Defaults.modifiers[t] || {}, s.modifiers ? s.modifiers[t] : {})
        }), this.modifiers = Object.keys(this.options.modifiers).map(function (t) {
            return dt({name: t}, i.options.modifiers[t])
        }).sort(function (t, e) {
    ...
    qt.Utils = ("undefined" != typeof window ? window : global).PopperUtils, qt.placements = Ot, qt.Defaults = $t;
    var Yt = "dropdown", Qt = "bs.dropdown", Ut = "." + Qt, Vt = ".data-api", Kt = f.fn[Yt],
        Xt = new RegExp("38|40|27"), Gt = "hide" + Ut, Zt = "hidden" + Ut, Jt = "click" + Ut + Vt,
        te = "keydown" + Ut + Vt, ee = "disabled", ie = "show", se = "dropdown-menu-right",
        ne = '[data-toggle="dropdown"]', oe = ".dropdown-menu", re = {
            offset: 0,
            flip: !0,
            ...
            return t.toggle = function () {
                var t;
                this._element.disabled || f(this._element).hasClass(ee) || (t = f(this._menu).hasClass(ie), h._clearMenus(), t || this.show(!0))
            }, t.show = function (t) {
                if (void 0 === t && (t = !1), !(this._element.disabled || f(this._element).hasClass(ee) || f(this._menu).hasClass(ie))) {
                    ...
                    if (f(s).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            ...
                            var n = this._element;
                            "parent" === this._config.reference ? n = s : g.isElement(this._config.reference) && (n = this._config.reference, void 0 !== this._config.reference.jquery && (n = this._config.reference[0])), "scrollParent" !== this._config.boundary && f(s).addClass("position-static"), this._popper = new qt(n, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === f(s).closest(".navbar-nav").length && f(document.body).children().on("mouseover", null, f.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), f(this._menu).toggleClass(ie), f(s).toggleClass(ie).trigger(f.Event("shown.bs.dropdown", e))
                    }
                }
            }, t.hide = function () {
                var t, e, i;
                this._element.disabled || f(this._element).hasClass(ee) || !f(this._menu).hasClass(ie) || (t = {relatedTarget: this._element}, e = f.Event(Gt, t), i = h._getParentFromElement(this._element), f(i).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), f(this._menu).toggleClass(ie), f(i).toggleClass(ie).trigger(f.Event(Zt, t))))
            }, t.dispose = function () {
                f.removeData(this._element, Qt), f(this._element).off(Ut), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function () {
                ...
                return t = l({}, this.constructor.Default, f(this._element).data(), t), g.typeCheckConfig(Yt, t, this.constructor.DefaultType), t
            }, t._getMenuElement = function () {
                var t;
                return this._menu || (t = h._getParentFromElement(this._element)) && (this._menu = t.querySelector(oe)), this._menu
            }, t._getPlacement = function () {
                var t = f(this._element.parentNode), e = "bottom-start";
                return t.hasClass("dropup") ? e = f(this._menu).hasClass(se) ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : f(this._menu).hasClass(se) && (e = "bottom-end"), e
                ...
                return this.each(function () {
                    var t = f(this).data(Qt);
                    if (t || (t = new h(this, "object" == typeof e ? e : null), f(this).data(Qt, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
            }, h._clearMenus = function (t) {
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(ne)), i = 0, s = e.length; i < s; i++) {
                    var n, o, r = h._getParentFromElement(e[i]), a = f(e[i]).data(Qt), l = {relatedTarget: e[i]};
                    t && "click" === t.type && (l.clickEvent = t), a && (n = a._menu, f(r).hasClass(ie) && (t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && f.contains(r, t.target) || (o = f.Event(Gt, l), f(r).trigger(o), o.isDefaultPrevented() || ("ontouchstart" in document.documentElement && f(document.body).children().off("mouseover", null, f.noop), e[i].setAttribute("aria-expanded", "false"), a._popper && a._popper.destroy(), f(n).removeClass(ie), f(r).removeClass(ie).trigger(f.Event(Zt, l))))))
                }
            }, h._getParentFromElement = function (t) {
                var e, i = g.getSelectorFromElement(t);
                return i && (e = document.querySelector(i)), e || t.parentNode
            }, h._dataApiKeydownHandler = function (t) {
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(oe).length)) : Xt.test(t.which)) && !this.disabled && !f(this).hasClass(ee)) {
                    var e = h._getParentFromElement(this), i = f(e).hasClass(ie);
                    if (i || 27 !== t.which) {
                        if (t.preventDefault(), t.stopPropagation(), !i || i && (27 === t.which || 32 === t.which)) return 27 === t.which && f(e.querySelector(ne)).trigger("focus"), void f(this).trigger("click");
                        var s,
    ...
    f(document).on(te, ne, le._dataApiKeydownHandler).on(te, oe, le._dataApiKeydownHandler).on(Jt + " keyup.bs.dropdown.data-api", le._clearMenus).on(Jt, ne, function (t) {
        t.preventDefault(), t.stopPropagation(), le._jQueryInterface.call(f(this), "toggle")
    }).on(Jt, ".dropdown form", function (t) {
        t.stopPropagation()
    }), f.fn[Yt] = le._jQueryInterface, f.fn[Yt].Constructor = le, f.fn[Yt].noConflict = function () {
        return f.fn[Yt] = Kt, le._jQueryInterface
    };
    var he = "modal", ce = "bs.modal", ue = "." + ce, de = f.fn[he],
        pe = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        fe = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, ge = "hidden" + ue,
        me = "show" + ue, ve = "focusin" + ue, _e = "resize" + ue, be = "click.dismiss" + ue,
        ye = "keydown.dismiss" + ue, we = "mousedown.dismiss" + ue, Ce = "modal-open", xe = "fade", ke = "show",
        De = "modal-static", Ee = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Se = ".sticky-top",
        Ie = function () {
            function n(t, e) {
            ...
            return t.toggle = function (t) {
                ...
                var e, i = this;
                this._isShown || this._isTransitioning || (f(this._element).hasClass(xe) && (this._isTransitioning = !0), e = f.Event(me, {relatedTarget: t}), f(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), f(this._element).on(be, '[data-dismiss="modal"]', function (t) {
                    return i.hide(t)
                }), f(this._dialog).on(we, function () {
                ...
                var e, i, s, n = this;
                t && t.preventDefault(), this._isShown && !this._isTransitioning && (e = f.Event("hide.bs.modal"), f(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, (i = f(this._element).hasClass(xe)) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), f(document).off(ve), f(this._element).removeClass(ke), f(this._element).off(be), f(this._dialog).off(we), i ? (s = g.getTransitionDurationFromElement(this._element), f(this._element).one(g.TRANSITION_END, function (t) {
                    return n._hideModal(t)
                }).emulateTransitionEnd(s)) : this._hideModal()))
            }, t.dispose = function () {
                [window, this._element, this._dialog].forEach(function (t) {
                    return f(t).off(ue)
                }), f(document).off(ve), f.removeData(this._element, ce), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, t.handleUpdate = function () {
                this._adjustDialog()
            }, t._getConfig = function (t) {
                return t = l({}, pe, t), g.typeCheckConfig(he, t, fe), t
                ...
                if ("static" === this._config.backdrop) {
                    ...
                    i || (this._element.style.overflowY = "hidden"), this._element.classList.add(De);
                    var s = g.getTransitionDurationFromElement(this._dialog);
                    f(this._element).off(g.TRANSITION_END), f(this._element).one(g.TRANSITION_END, function () {
                        t._element.classList.remove(De), i || f(t._element).one(g.TRANSITION_END, function () {
                            t._element.style.overflowY = ""
                        }).emulateTransitionEnd(t._element, s)
                    }).emulateTransitionEnd(s), this._element.focus()
                } else this.hide()
            }, t._showElement = function (t) {
                var e = this, i = f(this._element).hasClass(xe),
                ...
                function n() {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, f(e._element).trigger(r)
                }

                var o, r = f.Event("shown.bs.modal", {relatedTarget: t});
                i ? (o = g.getTransitionDurationFromElement(this._dialog), f(this._dialog).one(g.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
            }, t._enforceFocus = function () {
                var e = this;
                f(document).off(ve).on(ve, function (t) {
                    document !== t.target && e._element !== t.target && 0 === f(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function () {
                var e = this;
                this._isShown ? f(this._element).on(ye, function (t) {
                    e._config.keyboard && 27 === t.which ? (t.preventDefault(), e.hide()) : e._config.keyboard || 27 !== t.which || e._triggerBackdropTransition()
                }) : this._isShown || f(this._element).off(ye)
            }, t._setResizeEvent = function () {
                var e = this;
                this._isShown ? f(window).on(_e, function (t) {
                    return e.handleUpdate(t)
                }) : f(window).off(_e)
            }, t._hideModal = function () {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop(function () {
                    f(document.body).removeClass(Ce), t._resetAdjustments(), t._resetScrollbar(), f(t._element).trigger(ge)
                })
            }, t._removeBackdrop = function () {
                this._backdrop && (f(this._backdrop).remove(), this._backdrop = null)
            }, t._showBackdrop = function (t) {
                var e, i, s = this, n = f(this._element).hasClass(xe) ? xe : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), f(this._backdrop).appendTo(document.body), f(this._element).on(be, function (t) {
                        s._ignoreBackdropClick ? s._ignoreBackdropClick = !1 : t.target === t.currentTarget && s._triggerBackdropTransition()
                    }), n && g.reflow(this._backdrop), f(this._backdrop).addClass(ke), !t) return;
                    if (!n) return void t();
                    var o = g.getTransitionDurationFromElement(this._backdrop);
                    f(this._backdrop).one(g.TRANSITION_END, t).emulateTransitionEnd(o)
                } else {
                    !this._isShown && this._backdrop ? (f(this._backdrop).removeClass(ke), e = function () {
                        s._removeBackdrop(), t && t()
                    }, f(this._element).hasClass(xe) ? (i = g.getTransitionDurationFromElement(this._backdrop), f(this._backdrop).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e()) : t && t()
                }
                ...
                var t, e, i, s, n = this;
                this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(Ee)), e = [].slice.call(document.querySelectorAll(Se)), f(t).each(function (t, e) {
                ...
                }), i = document.body.style.paddingRight, s = f(document.body).css("padding-right"), f(document.body).data("padding-right", i).css("padding-right", parseFloat(s) + this._scrollbarWidth + "px")), f(document.body).addClass(Ce)
                ...
                return this.each(function () {
                    var t = f(this).data(ce), e = l({}, pe, f(this).data(), "object" == typeof i && i ? i : {});
                    if (t || (t = new n(this, e), f(this).data(ce, t)), "string" == typeof i) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i](s)
    ...
    f(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function (t) {
        var e, i = this, s = g.getSelectorFromElement(this);
        s && (e = document.querySelector(s));
        var n = f(e).data(ce) ? "toggle" : l({}, f(e).data(), f(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var o = f(e).one(me, function (t) {
            t.isDefaultPrevented() || o.one(ge, function () {
                f(i).is(":visible") && i.focus()
            })
        });
        Ie._jQueryInterface.call(f(e), n, this)
    }), f.fn[he] = Ie._jQueryInterface, f.fn[he].Constructor = Ie, f.fn[he].noConflict = function () {
        return f.fn[he] = de, Ie._jQueryInterface
    };
    var Te = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], Fe = {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), s = function (t) {
            ...
            s.forEach(function (t) {
                !function (t, e) {
                    ...
                    if (-1 !== e.indexOf(i)) return -1 === Te.indexOf(i) || Boolean(t.nodeValue.match(Ae) || t.nodeValue.match(Pe));
    ...
    var Ne = "tooltip", Oe = "bs.tooltip", ze = "." + Oe, He = f.fn[Ne], Le = "bs-tooltip",
        Re = new RegExp("(^|\\s)" + Le + "\\S+", "g"), We = ["sanitize", "whiteList", "sanitizeFn"], je = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, $e = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, qe = {
            animation: !0,
        ...
        }, Qe = "fade", Ue = "show", Ve = "hover", Ke = "focus", Xe = function () {
            function s(t, e) {
            ...
            return t.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var n = this.getTipElement(), o = g.getUID(this.constructor.NAME);
                    n.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && f(n).addClass(Qe);
                    ...
                    f(n).data(this.constructor.DATA_KEY, this), f.contains(this.element.ownerDocument.documentElement, this.tip) || f(n).appendTo(l), f(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new qt(this.element, n, this._getPopperConfig(a)), f(n).addClass(Ue), "ontouchstart" in document.documentElement && f(document.body).children().on("mouseover", null, f.noop);
                    var h, c = function () {
                        e.config.animation && e._fixTransition();
                        var t = e._hoverState;
                        e._hoverState = null, f(e.element).trigger(e.constructor.Event.SHOWN), "out" === t && e._leave(null, e)
                    };
                    f(this.tip).hasClass(Qe) ? (h = g.getTransitionDurationFromElement(this.tip), f(this.tip).one(g.TRANSITION_END, c).emulateTransitionEnd(h)) : c()
                }
            }, t.hide = function (t) {
                function e() {
                    s._hoverState !== Be && n.parentNode && n.parentNode.removeChild(n), s._cleanTipClass(), s.element.removeAttribute("aria-describedby"), f(s.element).trigger(s.constructor.Event.HIDDEN), null !== s._popper && s._popper.destroy(), t && t()
                }

                var i, s = this, n = this.getTipElement(), o = f.Event(this.constructor.Event.HIDE);
                f(this.element).trigger(o), o.isDefaultPrevented() || (f(n).removeClass(Ue), "ontouchstart" in document.documentElement && f(document.body).children().off("mouseover", null, f.noop), this._activeTrigger.click = !1, this._activeTrigger[Ke] = !1, this._activeTrigger[Ve] = !1, f(this.tip).hasClass(Qe) ? (i = g.getTransitionDurationFromElement(n), f(n).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e(), this._hoverState = "")
            }, t.update = function () {
                ...
                this.setElementContent(f(t.querySelectorAll(".tooltip-inner")), this.getTitle()), f(t).removeClass(Qe + " " + Ue)
            }, t.setElementContent = function (t, e) {
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Me(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? f(e).parent().is(t) || t.empty().append(e) : t.text(f(e).text())
            }, t.getTitle = function () {
                ...
                this.config.trigger.split(" ").forEach(function (t) {
                    ...
                    "click" === t ? f(s.element).on(s.constructor.Event.CLICK, s.config.selector, function (t) {
                        return s.toggle(t)
                    }) : "manual" !== t && (e = t === Ve ? s.constructor.Event.MOUSEENTER : s.constructor.Event.FOCUSIN, i = t === Ve ? s.constructor.Event.MOUSELEAVE : s.constructor.Event.FOCUSOUT, f(s.element).on(e, s.config.selector, function (t) {
                        return s._enter(t)
                ...
                (e = e || f(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), f(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusin" === t.type ? Ke : Ve] = !0), f(e.getTipElement()).hasClass(Ue) || e._hoverState === Be ? e._hoverState = Be : (clearTimeout(e._timeout), e._hoverState = Be, e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function () {
                    e._hoverState === Be && e.show()
                }, e.config.delay.show) : e.show())
            }, t._leave = function (t, e) {
                var i = this.constructor.DATA_KEY;
                (e = e || f(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), f(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? Ke : Ve] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function () {
                ...
                return Object.keys(e).forEach(function (t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(Ne, t, this.constructor.DefaultType), t.sanitize && (t.template = Me(t.template, t.whiteList, t.sanitizeFn)), t
            }, t._getDelegateConfig = function () {
                var t = {};
                if (this.config) for (var e in this.config) this.constructor.Default[e] !== this.config[e] && (t[e] = this.config[e]);
                return t
            }, t._cleanTipClass = function () {
                var t = f(this.getTipElement()), e = t.attr("class").match(Re);
                ...
                return this.each(function () {
                    var t = f(this).data(Oe), e = "object" == typeof i && i;
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new s(this, e), f(this).data(Oe, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    f.fn[Ne] = Xe._jQueryInterface, f.fn[Ne].Constructor = Xe, f.fn[Ne].noConflict = function () {
        return f.fn[Ne] = He, Xe._jQueryInterface
    };
    var Ge = "popover", Ze = "bs.popover", Je = "." + Ze, ti = f.fn[Ge], ei = "bs-popover",
        ii = new RegExp("(^|\\s)" + ei + "\\S+", "g"), si = l({}, Xe.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), ni = l({}, Xe.DefaultType, {content: "(string|element|function)"}), oi = {
            HIDE: "hide" + Je,
            HIDDEN: "hidden" + Je,
            SHOW: "show" + Je,
            SHOWN: "shown" + Je,
            ...
            return n.isWithContent = function () {
                ...
                f(this.getTipElement()).addClass(ei + "-" + t)
                ...
                return this.each(function () {
                    var t = f(this).data(Ze), e = "object" == typeof i ? i : null;
    ...
    f.fn[Ge] = ri._jQueryInterface, f.fn[Ge].Constructor = ri, f.fn[Ge].noConflict = function () {
        return f.fn[Ge] = ti, ri._jQueryInterface
    };
    var ai = "scrollspy", li = "bs.scrollspy", hi = "." + li, ci = f.fn[ai],
        ui = {offset: 10, method: "auto", target: ""},
        di = {offset: "number", method: "string", target: "(string|element)"}, pi = "active", fi = ".nav, .list-group",
        gi = ".nav-link", mi = ".list-group-item", vi = "position", _i = function () {
            function i(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + gi + "," + this._config.target + " " + mi + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, f(this._scrollElement).on("scroll.bs.scrollspy", function (t) {
                    return i._process(t)
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? "offset" : vi,
                    n = "auto" === this._config.method ? t : this._config.method, o = n === vi ? this._getScrollTop() : 0;
                ...
                f.removeData(this._element, li), f(this._scrollElement).off(hi), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function (t) {
                var e;
                return "string" != typeof (t = l({}, ui, "object" == typeof t && t ? t : {})).target && g.isElement(t.target) && ((e = f(t.target).attr("id")) || (e = g.getUID(ai), f(t.target).attr("id", e)), t.target = "#" + e), g.typeCheckConfig(ai, t, di), t
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(pi), i.addClass(pi)) : (i.addClass(pi), i.parents(fi).prev(gi + ", " + mi).addClass(pi), i.parents(fi).prev(".nav-item").children(gi).addClass(pi)), f(this._scrollElement).trigger("activate.bs.scrollspy", {relatedTarget: e})
            }, t._clear = function () {
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new i(this, "object" == typeof e && e), f(this).data(li, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
    ...
    }), f.fn[ai] = _i._jQueryInterface, f.fn[ai].Constructor = _i, f.fn[ai].noConflict = function () {
        return f.fn[ai] = ci, _i._jQueryInterface
    };
    var bi = "bs.tab", yi = f.fn.tab, wi = "active", Ci = ".active", xi = "> li > .active", ki = function () {
        function s(t) {
            this._element = t
        }
        ...
        return t.show = function () {
            var t, e, i, s, n, o, r, a, l = this;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(wi) || f(this._element).hasClass("disabled") || (e = f(this._element).closest(".nav, .list-group")[0], i = g.getSelectorFromElement(this._element), e && (s = "UL" === e.nodeName || "OL" === e.nodeName ? xi : Ci, n = (n = f.makeArray(f(e).find(s)))[n.length - 1]), o = f.Event("hide.bs.tab", {relatedTarget: this._element}), r = f.Event("show.bs.tab", {relatedTarget: n}), n && f(n).trigger(o), f(this._element).trigger(r), r.isDefaultPrevented() || o.isDefaultPrevented() || (i && (t = document.querySelector(i)), this._activate(this._element, e), a = function () {
            ...
            f.removeData(this._element, bi), this._element = null
            ...
            var n, o = this,
                r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? f(e).children(Ci) : f(e).find(xi))[0],
                a = i && r && f(r).hasClass("fade");
            r && a ? (n = g.getTransitionDurationFromElement(r), f(r).removeClass("show").one(g.TRANSITION_END, s).emulateTransitionEnd(n)) : s()
        }, t._transitionComplete = function (t, e, i) {
            var s, n, o;
            e && (f(e).removeClass(wi), (s = f(e.parentNode).find("> .dropdown-menu .active")[0]) && f(s).removeClass(wi), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)), f(t).addClass(wi), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && f(t.parentNode).hasClass("dropdown-menu") && ((n = f(t).closest(".dropdown")[0]) && (o = [].slice.call(n.querySelectorAll(".dropdown-toggle")), f(o).addClass(wi)), t.setAttribute("aria-expanded", !0)), i && i()
        }, s._jQueryInterface = function (i) {
            return this.each(function () {
                var t = f(this), e = t.data(bi);
                if (e || (e = new s(this), t.data(bi, e)), "string" == typeof i) {
    ...
    f(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (t) {
        t.preventDefault(), ki._jQueryInterface.call(f(this), "show")
    }), f.fn.tab = ki._jQueryInterface, f.fn.tab.Constructor = ki, f.fn.tab.noConflict = function () {
        return f.fn.tab = yi, ki._jQueryInterface
    };
    var Di = "toast", Ei = "bs.toast", Si = "." + Ei, Ii = f.fn[Di], Ti = "click.dismiss" + Si, Fi = "show",
        Ai = "showing", Pi = {animation: "boolean", autohide: "boolean", delay: "number"},
        Mi = {animation: !0, autohide: !0, delay: 500}, Ni = function () {
            function s(t, e) {
            ...
            var t = s.prototype;
            return t.show = function () {
                var t, e, i = this, s = f.Event("show.bs.toast");
                f(this._element).trigger(s), s.isDefaultPrevented() || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), t = function () {
                ...
                this._clearTimeout(), this._element.classList.contains(Fi) && this._element.classList.remove(Fi), f(this._element).off(Ti), f.removeData(this._element, Ei), this._element = null, this._config = null
            }, t._getConfig = function (t) {
                return t = l({}, Mi, f(this._element).data(), "object" == typeof t && t ? t : {}), g.typeCheckConfig(Di, t, this.constructor.DefaultType), t
            }, t._setListeners = function () {
                var t = this;
                f(this._element).on(Ti, '[data-dismiss="toast"]', function () {
                    return t.hide()
                })
            }, t._close = function () {
                function t() {
                ...
                return this.each(function () {
                    var t = f(this), e = t.data(Ei);
                    if (e || (e = new s(this, "object" == typeof i && i), t.data(Ei, e)), "string" == typeof i) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i](this)
                    }
                })
    ...
    f.fn[Di] = Ni._jQueryInterface, f.fn[Di].Constructor = Ni, f.fn[Di].noConflict = function () {
        return f.fn[Di] = Ii, Ni._jQueryInterface
    }, t.Alert = h, t.Button = b, t.Carousel = P, t.Collapse = q, t.Dropdown = le, t.Modal = Ie, t.Popover = ri, t.Scrollspy = _i, t.Tab = ki, t.Toast = Ni, t.Tooltip = Xe, t.Util = g, Object.defineProperty(t, "__esModule", {value: !0})
}), function (a) {
    function s(t, e) {
        var i = t.nodeName.toLowerCase();
        if ("area" !== i) return (/input|select|textarea|button|object/.test(i) ? !t.disabled : "a" == i && t.href || e) && r(t);
        var s, n = t.parentNode, o = n.name;
    ...
    a.ui = a.ui || {}, a.ui.version || (a.extend(a.ui, {
        ...
        propAttr: a.fn.prop || a.fn.attr, _focus: a.fn.focus, focus: function (e, i) {
            ...
            var t = a.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? this.parents().filter(function () {
            ...
            if (this.length) for (var e, i, s = a(this[0]); s.length && s[0] !== document;) {
        ...
        data: a.expr.createPseudo ? a.expr.createPseudo(function (e) {
            ...
            var e = a.attr(t, "tabindex"), i = isNaN(e);
            return (i || 0 <= e) && s(t, !i)
        }
    }), a(function () {
    ...
    var s, i;
    r.cleanData ? (s = r.cleanData, r.cleanData = function (t) {
        for (var e, i = 0; null != (e = t[i]); i++) try {
            r(e).triggerHandler("remove")
        } catch (t) {
        }
        s(t)
    }) : (i = r.fn.remove, r.fn.remove = function (t, e) {
        return this.each(function () {
        ...
        var s = e.split(".")[0], n = s + "-" + (e = e.split(".")[1]);
        i || (i = t, t = r.Widget), r.expr[":"][n] = function (t) {
            return !!r.data(t, e)
        }, r[s] = r[s] || {}, r[s][e] = function (t, e) {
            arguments.length && this._createWidget(t, e)
        };
        var o = new t;
        o.options = r.extend(!0, {}, o.options), r[s][e].prototype = r.extend(!0, o, {
            namespace: s,
            widgetName: e,
        ...
        r.fn[o] = function (i) {
            ...
            return i = !t && s.length ? r.extend.apply(null, [!0, i].concat(s)) : i, t && "_" === i.charAt(0) || (t ? this.each(function () {
                var t = r.data(this, o), e = t && r.isFunction(t[i]) ? t[i].apply(t, s) : t;
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        _generatePosition: function (t) {
            var e, i, s, n, o = this.options,
                r = "absolute" != this.cssPosition || this.scrollParent[0] != document && b.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
                a = /(html|body)/i.test(r[0].tagName), l = t.pageX, h = t.pageY;
            return this.originalPosition && (this.containment && (i = this.relative_container ? (e = this.relative_container.offset(), [this.containment[0] + e.left, this.containment[1] + e.top, this.containment[2] + e.left, this.containment[3] + e.top]) : this.containment, t.pageX - this.offset.click.left < i[0] && (l = i[0] + this.offset.click.left), t.pageY - this.offset.click.top < i[1] && (h = i[1] + this.offset.click.top), t.pageX - this.offset.click.left > i[2] && (l = i[2] + this.offset.click.left), t.pageY - this.offset.click.top > i[3] && (h = i[3] + this.offset.click.top)), o.grid && (s = o.grid[1] ? this.originalPageY + Math.round((h - this.originalPageY) / o.grid[1]) * o.grid[1] : this.originalPageY, h = i && (s - this.offset.click.top < i[1] || s - this.offset.click.top > i[3]) ? s - this.offset.click.top < i[1] ? s + o.grid[1] : s - o.grid[1] : s, n = o.grid[0] ? this.originalPageX + Math.round((l - this.originalPageX) / o.grid[0]) * o.grid[0] : this.originalPageX, l = i && (n - this.offset.click.left < i[0] || n - this.offset.click.left > i[2]) ? n - this.offset.click.left < i[0] ? n + o.grid[0] : n - o.grid[0] : n)), {
                top: h - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (b.browser.safari && b.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : r.scrollTop()),
                left: l - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (b.browser.safari && b.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : r.scrollLeft())
            }
        },
        _clear: function () {
    ...
    }), b.extend(b.ui.draggable, {version: "1.8.22"}), b.ui.plugin.add("draggable", "connectToSortable", {
        start: function (e, t) {
            var i = b(this).data("draggable"), s = i.options, n = b.extend({}, t, {item: i.element});
            ...
            var i = b(this).data("draggable"), s = b.extend({}, e, {item: i.element});
            ...
            var s = b(this).data("draggable"), n = this;
        ...
        start: function (t, e) {
            var i = b("body"), s = b(this).data("draggable").options;
        ...
        start: function (t, e) {
            var i = b(e.helper), s = b(this).data("draggable").options;
        ...
        start: function (t, e) {
            ...
            var i = b(this).data("draggable"), s = i.options, n = !1;
        ...
        start: function (t, e) {
            var i = b(this).data("draggable"), s = i.options;
            ...
            for (var i = b(this).data("draggable"), s = i.options, n = s.snapTolerance, o = e.offset.left, r = o + i.helperProportions.width, a = e.offset.top, l = a + i.helperProportions.height, h = i.snapElements.length - 1; 0 <= h; h--) {
                var c, u, d, p, f, g = i.snapElements[h].left, m = g + i.snapElements[h].width,
                    v = i.snapElements[h].top, _ = v + i.snapElements[h].height;
                g - n < o && o < m + n && v - n < a && a < _ + n || g - n < o && o < m + n && v - n < l && l < _ + n || g - n < r && r < m + n && v - n < a && a < _ + n || g - n < r && r < m + n && v - n < l && l < _ + n ? ("inner" != s.snapMode && (u = Math.abs(v - l) <= n, d = Math.abs(_ - a) <= n, p = Math.abs(g - r) <= n, f = Math.abs(m - o) <= n, u && (e.position.top = i._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: m
                }).left - i.margins.left)), c = u || d || p || f, "outer" != s.snapMode && (u = Math.abs(v - a) <= n, d = Math.abs(_ - l) <= n, p = Math.abs(g - o) <= n, f = Math.abs(m - r) <= n, u && (e.position.top = i._convertPositionTo("relative", {
                    top: v,
                    left: 0
                }).top - i.margins.top), d && (e.position.top = i._convertPositionTo("relative", {
        ...
        start: function (t, e) {
            var i, s = b(this).data("draggable").options, n = b.makeArray(b(s.stack)).sort(function (t, e) {
    ...
    p.widget("ui.droppable", {
        ...
        _drop: function (t, e) {
            ...
            return this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                if (t.options.greedy && !t.options.disabled && t.options.scope == i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && p.ui.intersect(i, p.extend(t, {offset: t.element.offset()}), t.options.tolerance)) return !(s = !0)
    ...
    }), p.extend(p.ui.droppable, {version: "1.8.22"}), p.ui.intersect = function (t, e, i) {
        if (!e.offset) return !1;
        var s = (t.positionAbs || t.position.absolute).left, n = s + t.helperProportions.width,
            o = (t.positionAbs || t.position.absolute).top, r = o + t.helperProportions.height, a = e.offset.left,
            l = a + e.proportions.width, h = e.offset.top, c = h + e.proportions.height;
        switch (i) {
            case"fit":
        ...
        current: null, droppables: {default: []}, prepareOffsets: function (t, e) {
            var i = p.ui.ddmanager.droppables[t.options.scope] || [], s = e ? e.type : null,
                n = (t.currentItem || t.element).find(":data(droppable)").andSelf();
            t:for (var o = 0; o < i.length; o++) if (!(i[o].options.disabled || t && !i[o].accept.call(i[o].element[0], t.currentItem || t.element))) {
                for (var r = 0; r < n.length; r++) if (n[r] == i[o].element[0]) {
    ...
    f.widget("ui.resizable", f.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element.addClass("ui-resizable"), f.extend(this, {
                ...
                zoom: 1,
                display: "block"
            })), this.originalElement.css({margin: this.originalElement.css("margin")}), this._proportionallyResize()), this.handles = t.handles || (f(".ui-resizable-handle", this.element).length ? {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
        ...
        _mouseStart: function (t) {
            var e = this.options, i = this.element.position(), s = this.element;
            ...
            var n = g(this.helper.css("left")), o = g(this.helper.css("top"));
            e.containment && (n += f(e.containment).scrollLeft() || 0, o += f(e.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                ...
                width: s.width(),
                height: s.height()
            }, this.originalPosition = {left: n, top: o}, this.sizeDiff = {
        ...
        _mouseDrag: function (t) {
            var e = this.helper, i = (this.options, this.originalMousePosition), s = this.axis,
                n = t.pageX - i.left || 0, o = t.pageY - i.top || 0, r = this._change[s];
            if (!r) return !1;
        ...
        _mouseStop: function (t) {
            this.resizing = !1;
            var e, i, s, n, o, r, a, l = this.options, h = this;
            ...
            }, r = parseInt(h.element.css("left"), 10) + (h.position.left - h.originalPosition.left) || null, a = parseInt(h.element.css("top"), 10) + (h.position.top - h.originalPosition.top) || null, l.animate || this.element.css(f.extend(o, {
                top: a,
                left: r
        ...
        _updateVirtualBoundaries: function (t) {
            ...
            (this._aspectRatio || t) && (e = r.minHeight * this.aspectRatio, s = r.minWidth / this.aspectRatio, i = r.maxHeight * this.aspectRatio, n = r.maxWidth / this.aspectRatio, e > r.minWidth && (r.minWidth = e), s > r.minHeight && (r.minHeight = s), i < r.maxWidth && (r.maxWidth = i), n < r.maxHeight && (r.maxHeight = n)), this._vBoundaries = r
        },
        ...
        _respectSize: function (t, e) {
            this.helper;
            var i = this._vBoundaries, s = (this._aspectRatio || e.shiftKey, this.axis),
        ...
        _renderProxy: function () {
            var t, e, i, s = this.element, n = this.options;
    ...
    }), f.extend(f.ui.resizable, {version: "1.8.22"}), f.ui.plugin.add("resizable", "alsoResize", {
        start: function (t, e) {
            function i(t) {
                f(t).each(function () {
                    var t = f(this);
            ...
            function i(t, i) {
                f(t).each(function () {
                    var t = f(this), s = f(this).data("resizable-alsoresize"), n = {},
            ...
            var e = f(this).data("resizable"), s = e.options, n = e.originalSize, r = e.originalPosition, a = {
        ...
        stop: function (e, t) {
            var i = f(this).data("resizable"), s = i.options, n = i._proportionallyResizeElements,
                o = n.length && /textarea/i.test(n[0].nodeName),
                r = o && f.ui.hasScroll(n[0], "left") ? 0 : i.sizeDiff.height, a = o ? 0 : i.sizeDiff.width,
                l = {width: i.size.width - a, height: i.size.height - r},
                h = parseInt(i.element.css("left"), 10) + (i.position.left - i.originalPosition.left) || null,
                c = parseInt(i.element.css("top"), 10) + (i.position.top - i.originalPosition.top) || null;
            i.element.animate(f.extend(l, c && h ? {top: c, left: h} : {}), {
        ...
        start: function (t, e) {
            var i, s, n, o, r, a, l, h = f(this).data("resizable"), c = h.options, u = h.element, d = c.containment,
            ...
            }, n = h.containerOffset, o = h.containerSize.height, r = h.containerSize.width, a = f.ui.hasScroll(p, "left") ? p.scrollWidth : r, l = f.ui.hasScroll(p) ? p.scrollHeight : o, h.parentData = {
                element: p,
                left: n.left,
                top: n.top,
                width: a,
            ...
            var i = f(this).data("resizable"), s = i.options, n = (i.containerSize, i.containerOffset),
                o = (i.size, i.position), r = i._aspectRatio || t.shiftKey, a = {top: 0, left: 0},
            ...
            var i = f(this).data("resizable"), s = i.options, n = (i.position, i.containerOffset),
                o = i.containerPosition, r = i.containerElement, a = f(i.helper), l = a.offset(),
                h = a.outerWidth() - i.sizeDiff.width, c = a.outerHeight() - i.sizeDiff.height;
        ...
        start: function (t, e) {
            var i = f(this).data("resizable"), s = i.options, n = i.size;
        ...
        resize: function (t, e) {
            var i = f(this).data("resizable"), s = i.options, n = i.size, o = i.originalSize, r = i.originalPosition,
                a = i.axis;
    ...
    h.widget("ui.selectable", h.ui.mouse, {
        ...
        _mouseStart: function (i) {
            ...
            this.opos = [i.pageX, i.pageY], this.options.disabled || (t = this.options, this.selectees = h(t.filter, this.element[0]), this._trigger("start", i), h(t.appendTo).append(this.helper), this.helper.css({
                ...
                t.startselected = !0, i.metaKey || i.ctrlKey || (t.$element.removeClass("ui-selected"), t.selected = !1, t.$element.addClass("ui-unselecting"), t.unselecting = !0, s._trigger("unselecting", i, {unselecting: t.element}))
            }), h(i.target).parents().andSelf().each(function () {
                var t = h.data(this, "selectable-item");
                if (t) {
                    var e = !i.metaKey && !i.ctrlKey || !t.$element.hasClass("ui-selected");
                    return t.$element.removeClass(e ? "ui-unselecting" : "ui-selected").addClass(e ? "ui-selecting" : "ui-unselecting"), t.unselecting = !e, t.selecting = e, (t.selected = e) ? s._trigger("selecting", i, {selecting: t.element}) : s._trigger("unselecting", i, {unselecting: t.element}), !1
                }
            }))
        },
        _mouseDrag: function (i) {
            ...
            if (this.dragged = !0, !this.options.disabled) {
                var t, n = this.options, o = this.opos[0], r = this.opos[1], a = i.pageX, l = i.pageY;
                return a < o && (t = a, a = o, o = t), l < r && (t = l, l = r, r = t), this.helper.css({
                    left: o,
                    top: r,
                    width: a - o,
                    height: l - r
    ...
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        _mouseDrag: function (t) {
            ...
            for (var s = this.items.length - 1; 0 <= s; s--) {
                var n = this.items[s], o = n.item[0], r = this._intersectsWithPointer(n);
        ...
        _getItemsAsjQuery: function (t) {
            var e = [], i = [], s = this._connectWith();
            if (s && t) for (var n = s.length - 1; 0 <= n; n--) for (var o = d(s[n]), r = o.length - 1; 0 <= r; r--) {
        ...
        _refreshItems: function (t) {
            ...
            var e = this.items,
                ...
                s = this._connectWith();
            if (s && this.ready) for (var n = s.length - 1; 0 <= n; n--) for (var o = d(s[n]), r = o.length - 1; 0 <= r; r--) {
                var a = d.data(o[r], this.widgetName);
            ...
            for (n = i.length - 1; 0 <= n; n--) for (var l = i[n][1], h = i[n][0], r = 0, c = h.length; r < c; r++) {
                var u = d(h[r]);
        ...
        _contactContainers: function (t) {
            for (var e = null, i = null, s = this.containers.length - 1; 0 <= s; s--) if (!d.ui.contains(this.currentItem[0], this.containers[s].element[0])) if (this._intersectsWith(this.containers[s].containerCache)) {
            ...
            if (e) if (1 === this.containers.length) this.containers[i]._trigger("over", t, this._uiHash(this)), this.containers[i].containerCache.over = 1; else if (this.currentContainer != this.containers[i]) {
                for (var n, o = 1e4, r = null, a = this.positionAbs[this.containers[i].floating ? "left" : "top"], l = this.items.length - 1; 0 <= l; l--) {
                    d.ui.contains(this.containers[i].element[0], this.items[l].item[0]) && (n = this.containers[i].floating ? this.items[l].item.offset().left : this.items[l].item.offset().top, Math.abs(n - a) < o && (o = Math.abs(n - a), r = this.items[l], this.direction = 0 < n - a ? "down" : "up"))
                }
        ...
        _generatePosition: function (t) {
            ...
            return this.originalPosition && (this.containment && (t.pageX - this.offset.click.left < this.containment[0] && (r = this.containment[0] + this.offset.click.left), t.pageY - this.offset.click.top < this.containment[1] && (a = this.containment[1] + this.offset.click.top), t.pageX - this.offset.click.left > this.containment[2] && (r = this.containment[2] + this.offset.click.left), t.pageY - this.offset.click.top > this.containment[3] && (a = this.containment[3] + this.offset.click.top)), e.grid && (n = this.originalPageY + Math.round((a - this.originalPageY) / e.grid[1]) * e.grid[1], a = this.containment && (n - this.offset.click.top < this.containment[1] || n - this.offset.click.top > this.containment[3]) ? n - this.offset.click.top < this.containment[1] ? n + e.grid[1] : n - e.grid[1] : n, o = this.originalPageX + Math.round((r - this.originalPageX) / e.grid[0]) * e.grid[0], r = this.containment && (o - this.offset.click.left < this.containment[0] || o - this.offset.click.left > this.containment[2]) ? o - this.offset.click.left < this.containment[0] ? o + e.grid[0] : o - e.grid[0] : o)), {
                top: a - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (d.browser.safari && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : i.scrollTop()),
                left: r - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (d.browser.safari && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : s ? 0 : i.scrollLeft())
            }
        },
        _rearrange: function (t, e, i, s) {
            i ? i[0].appendChild(this.placeholder[0]) : e.item[0].parentNode.insertBefore(this.placeholder[0], "down" == this.direction ? e.item[0] : e.item[0].nextSibling), this.counter = this.counter ? ++this.counter : 1;
            var n = this, o = this.counter;
    ...
    function c() {
        ...
        if (e && e.length && e[0] && e[e[0]]) for (var s = e.length; s--;) "string" == typeof e[t = e[s]] && (i[t.replace(/\-(\w)/g, function (t, e) {
    ...
    h.effects.animateClass = function (o, r, a, l) {
        return h.isFunction(a) && (l = a, a = null), this.queue(function () {
            var t, i = h(this), e = i.attr("style") || " ", s = u(c.call(this)), n = i.attr("class") || "";
            h.each(d, function (t, e) {
                ...
                queue: !1, duration: r, easing: a, complete: function () {
                    h.each(d, function (t, e) {
                        o[e] && i[e + "Class"](o[e])
        ...
        _addClass: h.fn.addClass, addClass: function (t, e, i, s) {
            return e ? h.effects.animateClass.apply(this, [{add: t}, e, i, s]) : this._addClass(t)
        }, _removeClass: h.fn.removeClass, removeClass: function (t, e, i, s) {
            return e ? h.effects.animateClass.apply(this, [{remove: t}, e, i, s]) : this._removeClass(t)
        }, _toggleClass: h.fn.toggleClass, toggleClass: function (t, e, i, s, n) {
        ...
        version: "1.8.22", save: function (t, e) {
            ...
            return i.wrap(t), i[0] !== e && !h.contains(i[0], e) || h(e).focus(), t = i.parent(), "static" == i.css("position") ? (t.css({position: "relative"}), i.css({position: "relative"})) : (h.extend(s, {
                position: i.css("position"),
                zIndex: i.css("z-index")
            }), h.each(["top", "left", "bottom", "right"], function (t, e) {
                s[e] = i.css(e), isNaN(parseInt(s[e], 10)) && (s[e] = "auto")
            }), i.css({position: "relative", top: 0, left: 0, right: "auto", bottom: "auto"})), t.css(s).show()
        ...
        def: "easeOutQuad", swing: function (t, e, i, s, n) {
            ...
            return 0 == e ? i : 1 == (e /= n) ? i + s : (r = r || .3 * n, o = a < Math.abs(s) ? (a = s, r / 4) : r / (2 * Math.PI) * Math.asin(s / a), -(a * Math.pow(2, 10 * --e) * Math.sin(2 * (e * n - o) * Math.PI / r)) + i)
        }, easeOutElastic: function (t, e, i, s, n) {
            var o = 1.70158, r = 0, a = s;
            return 0 == e ? i : 1 == (e /= n) ? i + s : (r = r || .3 * n, o = a < Math.abs(s) ? (a = s, r / 4) : r / (2 * Math.PI) * Math.asin(s / a), a * Math.pow(2, -10 * e) * Math.sin(2 * (e * n - o) * Math.PI / r) + s + i)
        }, easeInOutElastic: function (t, e, i, s, n) {
            var o = 1.70158, r = 0, a = s;
            return 0 == e ? i : 2 == (e /= n / 2) ? i + s : (r = r || .3 * n * 1.5, o = a < Math.abs(s) ? (a = s, r / 4) : r / (2 * Math.PI) * Math.asin(s / a), e < 1 ? -.5 * a * Math.pow(2, 10 * --e) * Math.sin(2 * (e * n - o) * Math.PI / r) + i : a * Math.pow(2, -10 * --e) * Math.sin(2 * (e * n - o) * Math.PI / r) * .5 + s + i)
    ...
    h.effects.blind = function (l) {
        return this.queue(function () {
            var t = h(this), e = ["position", "top", "bottom", "left", "right"],
                i = h.effects.setMode(t, l.options.mode || "hide"), s = l.options.direction || "vertical";
            h.effects.save(t, e), t.show();
            var n = h.effects.createWrapper(t).css({overflow: "hidden"}), o = "vertical" == s ? "height" : "width",
    ...
    f.effects.bounce = function (p) {
        return this.queue(function () {
            var t = f(this), e = ["position", "top", "bottom", "left", "right"],
                i = f.effects.setMode(t, p.options.mode || "effect"), s = p.options.direction || "up",
                n = p.options.distance || 20, o = p.options.times || 5, r = p.duration || 250;
            /show|hide/.test(i) && e.push("opacity"), f.effects.save(t, e), t.show(), f.effects.createWrapper(t);
            var a = "up" == s || "down" == s ? "top" : "left", l = "up" == s || "left" == s ? "pos" : "neg",
                n = p.options.distance || ("top" == a ? t.outerHeight(!0) / 3 : t.outerWidth(!0) / 3);
            "show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n), "hide" == i && (n /= 2 * o), "hide" != i && o--, "show" == i && ((h = {opacity: 1})[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(h, r / 2, p.options.easing), n /= 2, o--);
            for (var h, c = 0; c < o; c++) {
                var u, d = {};
                (u = {})[a] = ("pos" == l ? "-=" : "+=") + n, d[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, r / 2, p.options.easing).animate(d, r / 2, p.options.easing), n = "hide" == i ? 2 * n : n / 2
            }
            "hide" == i ? ((h = {opacity: 0})[a] = ("pos" == l ? "-=" : "+=") + n, t.animate(h, r / 2, p.options.easing, function () {
                t.hide(), f.effects.restore(t, e), f.effects.removeWrapper(t), p.callback && p.callback.apply(this, arguments)
            })) : (d = {}, (u = {})[a] = ("pos" == l ? "-=" : "+=") + n, d[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, r / 2, p.options.easing).animate(d, r / 2, p.options.easing, function () {
    ...
    c.effects.clip = function (h) {
        return this.queue(function () {
            var t = c(this), e = ["position", "top", "bottom", "left", "right", "height", "width"],
                i = c.effects.setMode(t, h.options.mode || "hide"), s = h.options.direction || "vertical";
            c.effects.save(t, e), t.show();
            var n = c.effects.createWrapper(t).css({overflow: "hidden"}), o = "IMG" == t[0].tagName ? n : t,
    ...
    h.effects.drop = function (l) {
        return this.queue(function () {
            var t = h(this), e = ["position", "top", "bottom", "left", "right", "opacity"],
                i = h.effects.setMode(t, l.options.mode || "hide"), s = l.options.direction || "left";
            h.effects.save(t, e), t.show(), h.effects.createWrapper(t);
            var n = "up" == s || "down" == s ? "top" : "left", o = "up" == s || "left" == s ? "pos" : "neg",
    ...
    h.effects.explode = function (l) {
        return this.queue(function () {
            ...
            var i = h(this).show().css("visibility", "hidden"), s = i.offset();
            s.top -= parseInt(i.css("marginTop"), 10) || 0, s.left -= parseInt(i.css("marginLeft"), 10) || 0;
            for (var n = i.outerWidth(!0), o = i.outerHeight(!0), r = 0; r < t; r++) for (var a = 0; a < e; a++) i.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: n / e * -a,
                top: o / t * -r
    ...
    s.effects.fade = function (i) {
        return this.queue(function () {
            var t = s(this), e = s.effects.setMode(t, i.options.mode || "hide");
            t.animate({opacity: e}, {
    ...
    f.effects.fold = function (p) {
        return this.queue(function () {
            var t = f(this), e = ["position", "top", "bottom", "left", "right"],
                i = f.effects.setMode(t, p.options.mode || "hide"), s = p.options.size || 15,
                n = !!p.options.horizFirst, o = p.duration ? p.duration / 2 : f.fx.speeds._default / 2;
            f.effects.save(t, e), t.show();
            var r = f.effects.createWrapper(t).css({overflow: "hidden"}), a = "show" == i != n,
                l = a ? ["width", "height"] : ["height", "width"],
                h = a ? [r.width(), r.height()] : [r.height(), r.width()], c = /([0-9]+)%/.exec(s);
    ...
    o.effects.highlight = function (n) {
        return this.queue(function () {
            var t = o(this), e = ["backgroundImage", "backgroundColor", "opacity"],
                i = o.effects.setMode(t, n.options.mode || "show"), s = {backgroundColor: t.css("backgroundColor")};
            "hide" == i && (s.opacity = 0), o.effects.save(t, e), t.show().css({
                backgroundImage: "none",
                backgroundColor: n.options.color || "#ffff99"
            }).animate(s, {
                queue: !1, duration: n.duration, easing: n.options.easing, complete: function () {
    ...
    l.effects.pulsate = function (a) {
        return this.queue(function () {
            var t = l(this), e = l.effects.setMode(t, a.options.mode || "show"), i = 2 * (a.options.times || 5) - 1,
                s = a.duration ? a.duration / 2 : l.fx.speeds._default / 2, n = t.is(":visible"), o = 0;
    ...
    g.effects.puff = function (o) {
        return this.queue(function () {
            var t = g(this), e = g.effects.setMode(t, o.options.mode || "hide"),
                i = parseInt(o.options.percent, 10) || 150, s = i / 100, n = {height: t.height(), width: t.width()};
            g.extend(o.options, {
                fade: !0,
                mode: e,
                percent: "hide" == e ? i : 100,
                from: "hide" == e ? n : {height: n.height * s, width: n.width * s}
            }), t.effect("scale", o.options, o.duration, o.callback), t.dequeue()
        })
    }, g.effects.scale = function (h) {
        return this.queue(function () {
            var t = g(this), e = g.extend(!0, {}, h.options), i = g.effects.setMode(t, h.options.mode || "effect"),
                s = parseInt(h.options.percent, 10) || (0 == parseInt(h.options.percent, 10) || "hide" == i ? 0 : 100),
                n = h.options.direction || "both", o = h.options.origin;
            ...
            var a = "horizontal" != n ? s / 100 : 1, l = "vertical" != n ? s / 100 : 1;
            t.to = {
                height: r.height * a,
                width: r.width * l
        ...
        return this.queue(function () {
            var t, e = g(this),
                ...
                n = ["width", "height", "overflow"], o = ["fontSize"],
                r = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
                a = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
                l = g.effects.setMode(e, f.options.mode || "effect"), h = f.options.restore || !1,
                c = f.options.scale || "both", u = f.options.origin, d = {height: e.height(), width: e.width()};
            ...
            var p = {
                from: {y: e.from.height / d.height, x: e.from.width / d.width},
                to: {y: e.to.height / d.height, x: e.to.width / d.width}
            };
            "box" != c && "both" != c || (p.from.y != p.to.y && (i = i.concat(r), e.from = g.effects.setTransition(e, r, p.from.y, e.from), e.to = g.effects.setTransition(e, r, p.to.y, e.to)), p.from.x != p.to.x && (i = i.concat(a), e.from = g.effects.setTransition(e, a, p.from.x, e.from), e.to = g.effects.setTransition(e, a, p.to.x, e.to))), "content" != c && "both" != c || p.from.y == p.to.y || (i = i.concat(o), e.from = g.effects.setTransition(e, o, p.from.y, e.from), e.to = g.effects.setTransition(e, o, p.to.y, e.to)), g.effects.save(e, h ? i : s), e.show(), g.effects.createWrapper(e), e.css("overflow", "hidden").css(e.from), "content" != c && "both" != c || (r = r.concat(["marginTop", "marginBottom"]).concat(o), a = a.concat(["marginLeft", "marginRight"]), n = i.concat(r).concat(a), e.find("*[width]").each(function () {
                var t = g(this);
                h && g.effects.save(t, n);
                var e = t.height(), i = t.width();
                t.from = {height: e * p.from.y, width: i * p.from.x}, t.to = {
                    height: e * p.to.y,
                    width: i * p.to.x
                }, p.from.y != p.to.y && (t.from = g.effects.setTransition(t, r, p.from.y, t.from), t.to = g.effects.setTransition(t, r, p.to.y, t.to)), p.from.x != p.to.x && (t.from = g.effects.setTransition(t, a, p.from.x, t.from), t.to = g.effects.setTransition(t, a, p.to.x, t.to)), t.css(t.from), t.animate(t.to, f.duration, f.options.easing, function () {
                    h && g.effects.restore(t, n)
                })
            })), e.animate(e.to, {
                queue: !1, duration: f.duration, easing: f.options.easing, complete: function () {
    ...
    p.effects.shake = function (d) {
        return this.queue(function () {
            var t = p(this), e = ["position", "top", "bottom", "left", "right"],
                i = (p.effects.setMode(t, d.options.mode || "effect"), d.options.direction || "left"),
                s = d.options.distance || 20, n = d.options.times || 3, o = d.duration || d.options.duration || 140;
            p.effects.save(t, e), t.show(), p.effects.createWrapper(t);
            var r = "up" == i || "down" == i ? "top" : "left", a = "up" == i || "left" == i ? "pos" : "neg", l = {},
                h = {}, c = {};
    ...
    h.effects.slide = function (l) {
        return this.queue(function () {
            var t = h(this), e = ["position", "top", "bottom", "left", "right"],
                i = h.effects.setMode(t, l.options.mode || "show"), s = l.options.direction || "left";
    ...
    a.effects.transfer = function (r) {
        return this.queue(function () {
            var t = a(this), e = a(r.options.to), i = e.offset(),
                s = {top: i.top, left: i.left, height: e.innerHeight(), width: e.innerWidth()}, n = t.offset(),
    ...
    d.widget("ui.accordion", {
        options: {
            ...
            if (!(this.options.disabled || t.altKey || t.ctrlKey)) {
                var e = d.ui.keyCode, i = this.headers.length, s = this.headers.index(t.target), n = !1;
                switch (t.keyCode) {
                    case e.RIGHT:
                    case e.DOWN:
            ...
            var i = this.options;
            if (!i.disabled) if (t.target) {
                var s, n, o = d(t.currentTarget || e), r = o[0] === this.active[0];
                i.active = (!i.collapsible || !r) && this.headers.index(o), this.running || !i.collapsible && r || (s = this.active, h = o.next(), a = this.active.next(), l = {
                    options: i,
                    newHeader: r && i.collapsible ? d([]) : o,
                    oldHeader: this.active,
                    newContent: r && i.collapsible ? d([]) : h,
                    oldContent: a
                }, n = this.headers.index(this.active[0]) > this.headers.index(o[0]), this.active = r ? d([]) : o, this._toggle(h, a, l, r, n), s.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(i.icons.headerSelected).addClass(i.icons.header), r || (o.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(i.icons.header).addClass(i.icons.headerSelected), o.next().addClass("ui-accordion-content-active")))
            } else {
            ...
            var l, h, c, u;
            o._trigger("changestart", null, o.data), o.running = 0 === e.size() ? t.size() : e.size(), r.animated ? (l = {}, l = r.collapsible && s ? {
                toShow: d([]),
                toHide: e,
                complete: a,
                down: n,
                ...
                down: n,
                autoHeight: r.autoHeight || r.fillSpace
            }, r.proxied || (r.proxied = r.animated), r.proxiedDuration || (r.proxiedDuration = r.duration), r.animated = d.isFunction(r.proxied) ? r.proxied(l) : r.proxied, r.duration = d.isFunction(r.proxiedDuration) ? r.proxiedDuration(l) : r.proxiedDuration, h = d.ui.accordion.animations, c = r.duration, !(u = r.animated) || h[u] || d.easing[u] || (u = "slide"), h[u] || (h[u] = function (t) {
                this.slide(t, {easing: u, duration: c || 700})
            }), h[u](l)) : (r.collapsible && s ? t.toggle() : (e.hide(), t.show()), a(!0)), e.prev().attr({
                "aria-expanded": "false",
                "aria-selected": "false",
                tabIndex: -1
            }).blur(), t.prev().attr({"aria-expanded": "true", "aria-selected": "true", tabIndex: 0}).focus()
        ...
        version: "1.8.22", animations: {
            slide: function (s, t) {
                ...
                (s = d.extend({
                    easing: "swing",
                    duration: 300
                }, s, t)).toHide.size() ? s.toShow.size() ? (e = s.toShow.css("overflow"), i = 0, n = {}, o = {}, r = s.toShow, a = r[0].style.width, r.width(r.parent().width() - parseFloat(r.css("paddingLeft")) - parseFloat(r.css("paddingRight")) - (parseFloat(r.css("borderLeftWidth")) || 0) - (parseFloat(r.css("borderRightWidth")) || 0)), d.each(["height", "paddingTop", "paddingBottom"], function (t, e) {
                    o[e] = "hide";
                    var i = ("" + d.css(s.toShow[0], e)).match(/^([\d+-.]+)(.*)$/);
                    n[e] = {value: i[1], unit: i[2] || "px"}
                }), s.toShow.css({
                    height: 0,
                    overflow: "hidden"
                    ...
                    }, duration: s.duration, easing: s.easing, complete: function () {
                        s.autoHeight || s.toShow.css("height", ""), s.toShow.css({width: a, overflow: e}), s.complete()
                    }
                })) : s.toHide.animate({
                    height: "hide",
                    paddingTop: "hide",
                    paddingBottom: "hide"
                }, s) : s.toShow.animate({height: "show", paddingTop: "show", paddingBottom: "show"}, s)
    ...
    r.widget("ui.autocomplete", {
        options: {
            ...
            var i, n = this, o = this.element[0].ownerDocument;
            this.isMultiLine = this.element.is("textarea"), this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({
                ...
                focus: function (t, e) {
                    ...
                    var i = e.item.data("item.autocomplete"), s = n.previous;
                    n.element[0] !== o.activeElement && (n.element.focus(), n.previous = s, setTimeout(function () {
                        n.previous = s, n.selectedItem = i
                    }, 1)), !1 !== n._trigger("select", t, {item: i}) && n.element.val(i.value), n.term = n.element.val(), n.close(t), n.selectedItem = i
                }, blur: function (t, e) {
            ...
            r.isArray(this.options.source) ? (i = this.options.source, this.source = function (t, e) {
                ...
                s.xhr && s.xhr.abort(), s.xhr = r.ajax({
                    url: e, data: t, dataType: "json", success: function (t, e) {
                        i(t)
                    }, error: function () {
                        i([])
                    }
            ...
            return t.length && t[0].label && t[0].value ? t : r.map(t, function (t) {
                return "string" == typeof t ? {label: t, value: t} : r.extend({
            ...
            this._renderMenu(e, t), this.menu.deactivate(), this.menu.refresh(), e.show(), this._resizeMenu(), e.position(r.extend({of: this.element}, this.options.position)), this.options.autoFocus && this.menu.next(new r.Event("mouseover"))
    ...
    n.widget("ui.menu", {
        _create: function () {
            ...
            var i, s, n;
            this.deactivate(), this.hasScroll() && (i = e.offset().top - this.element.offset().top, s = this.element.scrollTop(), n = this.element.height(), i < 0 ? this.element.scrollTop(s + i) : n <= i && this.element.scrollTop(s + i - n + e.height())), this.active = e.eq(0).children("a").addClass("ui-state-hover").attr("id", "ui-active-menuitem").end(), this._trigger("focus", t, {item: e})
        }, deactivate: function () {
            ...
            if (this.hasScroll()) {
                ...
                var e = this.active.offset().top, i = this.element.height(),
    ...
    o.widget("ui.button", {
        ...
        _create: function () {
            this.element.closest("form").unbind("reset.button").bind("reset.button", r), "boolean" != typeof this.options.disabled ? this.options.disabled = !!this.element.propAttr("disabled") : this.element.propAttr("disabled", this.options.disabled), this._determineButtonType(), this.hasTitle = !!this.buttonElement.attr("title");
            var e = this, i = this.options, t = "checkbox" === this.type || "radio" === this.type,
                s = "ui-state-hover" + (t ? "" : " ui-state-active"), n = "ui-state-focus";
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function (t, e) {
            ...
            var n, o, r = this._get(e, "showOn");
            "focus" != r && "both" != r || t.focus(this._showDatepicker), "button" != r && "both" != r || (n = this._get(e, "buttonText"), o = this._get(e, "buttonImage"), e.trigger = $(this._get(e, "buttonImageOnly") ? $("<img/>").addClass(this._triggerClass).attr({
                src: o,
                alt: n,
                title: n
        ...
        _enableDatepicker: function (e) {
            var t, i, s = $(e), n = $.data(e, PROP_NAME);
        ...
        _doKeyDown: function (t) {
            ...
            if (e._keyEvent = !0, $.datepicker._datepickerShowing) switch (t.keyCode) {
                ...
                case 13:
                    ...
                    var o, r = $.datepicker._get(e, "onSelect");
                    return r ? (o = $.datepicker._formatDate(e), r.apply(e.input ? e.input[0] : null, [o, e])) : $.datepicker._hideDatepicker(), !1;
                case 27:
        ...
        _showDatepicker: function (t) {
            ...
            "input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), $.datepicker._isDisabledDatepicker(t) || $.datepicker._lastInput == t || (i = $.datepicker._getInst(t), $.datepicker._curInst && $.datepicker._curInst != i && ($.datepicker._curInst.dpDiv.stop(!0, !0), i && $.datepicker._datepickerShowing && $.datepicker._hideDatepicker($.datepicker._curInst.input[0])), !1 !== (s = (e = $.datepicker._get(i, "beforeShow")) ? e.apply(t, [t, i]) : {}) && (extendRemove(i.settings, s), i.lastVal = null, $.datepicker._lastInput = t, $.datepicker._setDateFromField(i), $.datepicker._inDialog && (t.value = ""), $.datepicker._pos || ($.datepicker._pos = $.datepicker._findPos(t), $.datepicker._pos[1] += t.offsetHeight), n = !1, $(t).parents().each(function () {
                ...
                left: o.left + "px",
                top: o.top + "px"
            }), i.inline || (r = $.datepicker._get(i, "showAnim"), a = $.datepicker._get(i, "duration"), l = function () {
        ...
        _updateDatepicker: function (t) {
            ...
            var s, n = this._getNumberOfMonths(t), o = n[1];
        ...
        parseDate: function (i, o, t) {
            ...
            for (var a = "string" != typeof (a = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff) ? a : (new Date).getFullYear() % 100 + parseInt(a, 10), l = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, h = (t ? t.dayNames : null) || this._defaults.dayNames, c = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, u = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, p = -1, f = -1, g = -1, m = !1, v = 0, _ = 0; _ < i.length; _++) if (m) "'" != i.charAt(_) || r("'") ? n() : m = !1; else switch (i.charAt(_)) {
                ...
                case"y":
                    ...
                    break;
                case"@":
                    var b, d = (b = new Date(e("@"))).getFullYear(), p = b.getMonth() + 1, f = b.getDate();
                    break;
                case"!":
            ...
            if (-1 == d ? d = (new Date).getFullYear() : d < 100 && (d += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (d <= a ? 0 : -100)), -1 < g) for (p = 1, f = g; ;) {
        ...
        formatDate: function (i, t, e) {
            ...
            var r = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                h = (e ? e.monthNames : null) || this._defaults.monthNames, c = "", u = !1;
            if (t) for (var d = 0; d < i.length; d++) if (u) "'" != i.charAt(d) || n("'") ? c += i.charAt(d) : u = !1; else switch (i.charAt(d)) {
                case"d":
                    c += s("d", t.getDate(), 2);
                    break;
                case"D":
        ...
        _possibleChars: function (i) {
            ...
            for (var e = "", s = !1, n = 0; n < i.length; n++) if (s) "'" != i.charAt(n) || t("'") ? e += i.charAt(n) : s = !1; else switch (i.charAt(n)) {
                case"d":
                case"m":
                case"y":
                case"@":
        ...
        _setDateFromField: function (t, e) {
            if (t.input.val() != t.lastVal) {
                var i, s = this._get(t, "dateFormat"), n = t.lastVal = t.input ? t.input.val() : null,
                    o = i = this._getDefaultDate(t), r = this._getFormatConfig(t);
                try {
                    o = this.parseDate(s, n, r) || i
                } catch (t) {
                    this.log(t), n = e ? "" : n
                }
        ...
        _attachHandlers: function (t) {
            var e = this._get(t, "stepMonths"), i = "#" + t.id;
        ...
        _generateHTML: function (t) {
            var e = new Date, e = this._daylightSavingAdjust(new Date(e.getFullYear(), e.getMonth(), e.getDate())),
                i = this._get(t, "isRTL"), s = this._get(t, "showButtonPanel"), n = this._get(t, "hideIfNoPrevNext"),
                o = this._get(t, "navigationAsDateFormat"), r = this._getNumberOfMonths(t),
                a = this._get(t, "showCurrentAtPos"), l = this._get(t, "stepMonths"), h = 1 != r[0] || 1 != r[1],
                c = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) : new Date(9999, 9, 9)),
                u = this._getMinMaxDate(t, "min"), d = this._getMinMaxDate(t, "max"), p = t.drawMonth - a,
                f = t.drawYear;
            if (p < 0 && (p += 12, f--), d) for (var g = this._daylightSavingAdjust(new Date(d.getFullYear(), d.getMonth() - r[0] * r[1] + 1, d.getDate())), g = u && g < u ? u : g; this._daylightSavingAdjust(new Date(f, p, 1)) > g;) --p < 0 && (p = 11, f--);
            ...
            for (var m = this._get(t, "prevText"), m = o ? this.formatDate(m, this._daylightSavingAdjust(new Date(f, p - l, 1)), this._getFormatConfig(t)) : m, v = this._canAdjustMonth(t, -1, f, p) ? '<a class="ui-datepicker-prev ui-corner-all" data-handler="prev" data-event="click" title="' + m + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + m + "</span></a>" : n ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + m + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + m + "</span></a>", _ = this._get(t, "nextText"), _ = o ? this.formatDate(_, this._daylightSavingAdjust(new Date(f, p + l, 1)), this._getFormatConfig(t)) : _, b = this._canAdjustMonth(t, 1, f, p) ? '<a class="ui-datepicker-next ui-corner-all" data-handler="next" data-event="click" title="' + _ + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + _ + "</span></a>" : n ? "" : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' + _ + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + _ + "</span></a>", y = this._get(t, "currentText"), w = this._get(t, "gotoCurrent") && t.currentDay ? c : e, y = o ? this.formatDate(y, w, this._getFormatConfig(t)) : y, C = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>", x = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? C : "") + (this._isInRange(t, w) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + y + "</button>" : "") + (i ? "" : C) + "</div>" : "", k = parseInt(this._get(t, "firstDay"), 10), k = isNaN(k) ? 0 : k, D = this._get(t, "showWeek"), E = this._get(t, "dayNames"), S = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), I = this._get(t, "monthNames"), T = this._get(t, "monthNamesShort"), F = this._get(t, "beforeShowDay"), A = this._get(t, "showOtherMonths"), P = this._get(t, "selectOtherMonths"), M = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", O = 0; O < r[0]; O++) {
                ...
                this.maxRows = 4;
                for (var H = 0; H < r[1]; H++) {
                    var L = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)), R = " ui-corner-all", W = "";
                    if (h) {
                        if (W += '<div class="ui-datepicker-group', 1 < r[1]) switch (H) {
                            case 0:
                    ...
                    W += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + R + '">' + (/all|left/.test(R) && 0 == O ? i ? b : v : "") + (/all|right/.test(R) && 0 == O ? i ? v : b : "") + this._generateMonthYearHeader(t, p, f, u, d, 0 < O || 0 < H, I, T) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                    ...
                    var Q = (this._getFirstDayOfMonth(f, p) - k + 7) % 7, U = Math.ceil((Q + Y) / 7),
                        V = h && this.maxRows > U ? this.maxRows : U;
                    this.maxRows = V;
                    for (var K = this._daylightSavingAdjust(new Date(f, p, 1 - Q)), X = 0; X < V; X++) {
                        W += "<tr>";
                        for (var G = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(K) + "</td>" : "", q = 0; q < 7; q++) {
                            var Z = F ? F.apply(t.input ? t.input[0] : null, [K]) : [!0, ""], J = K.getMonth() != p,
                                tt = J && !P || !Z[0] || u && K < u || d && d < K;
                            G += '<td class="' + (5 <= (q + k + 6) % 7 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (K.getTime() == L.getTime() && p == t.selectedMonth && t._keyEvent || M.getTime() == K.getTime() && M.getTime() == L.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !A ? "" : " " + Z[1] + (K.getTime() == c.getTime() ? " " + this._currentClass : "") + (K.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (J && !A || !Z[2] ? "" : ' title="' + Z[2] + '"') + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + K.getMonth() + '" data-year="' + K.getFullYear() + '"') + ">" + (J && !A ? "&#xa0;" : tt ? '<span class="ui-state-default">' + K.getDate() + "</span>" : '<a class="ui-state-default' + (K.getTime() == e.getTime() ? " ui-state-highlight" : "") + (K.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + K.getDate() + "</a>") + "</td>", K.setDate(K.getDate() + 1), K = this._daylightSavingAdjust(K)
                        }
                        W += G + "</tr>"
                    }
                    11 < ++p && (p = 0, f++), z += W += "</tbody></table>" + (h ? "</div>" + (0 < r[0] && H == r[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : "")
                }
                N += z
            }
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, o, r, a) {
            ...
            if (c || (u += d + (!o && l && h ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", o || !h) u += '<span class="ui-datepicker-year">' + i + "</span>"; else {
                ...
                var v = this._get(t, "yearRange").split(":"), _ = (new Date).getFullYear(), b = m(v[0]),
                    y = Math.max(b, m(v[1] || "")), b = s ? Math.max(b, s.getFullYear()) : b,
    ...
    a.widget("ui.dialog", {
        options: {
            ...
            var e = this, i = e.options, t = i.title || "&#160;", s = a.ui.dialog.getTitleId(e.element),
                n = (e.uiDialog = a("<div></div>")).appendTo(document.body).hide().addClass(l + i.dialogClass).css({zIndex: i.zIndex}).attr("tabIndex", -1).css("outline", 0).keydown(function (t) {
                    i.closeOnEscape && !t.isDefaultPrevented() && t.keyCode && t.keyCode === a.ui.keyCode.ESCAPE && (e.close(t), t.preventDefault())
                }).attr({role: "dialog", "aria-labelledby": s}).mousedown(function (t) {
                    e.moveToTop(!1, t)
                }),
            ...
            if (!this._isOpen) {
                var t = this, e = t.options, i = t.uiDialog;
                return t.overlay = e.modal ? new a.ui.dialog.overlay(t) : null, t._size(), t._position(e.position), i.show(e.show), t.moveToTop(!0), e.modal && i.bind("keydown.ui-dialog", function (t) {
                    if (t.keyCode === a.ui.keyCode.TAB) {
                        var e = a(":tabbable", this), i = e.filter(":first"), s = e.filter(":last");
            ...
            var s, n = this, o = n.options, r = a(document);
            ...
            var s = this, n = s.options, e = s.uiDialog.css("position"),
            ...
            var e, i = [], s = [0, 0];
            t = t ? (("string" == typeof t || "object" == typeof t && "0" in t) && (1 === (i = t.split ? t.split(" ") : [t[0], t[1]]).length && (i[1] = i[0]), a.each(["left", "top"], function (t, e) {
                +i[t] === i[t] && (s[t] = i[t], i[t] = e)
            }), t = {
                my: i.join(" "),
                at: i.join(" "),
                offset: s.join(" ")
            }), a.extend({}, a.ui.dialog.prototype.options.position, t)) : a.ui.dialog.prototype.options.position, (e = this.uiDialog.is(":visible")) || this.uiDialog.show(), this.uiDialog.css({
                top: 0,
                left: 0
            }).position(a.extend({of: window}, t)), e || this.uiDialog.hide()
        }, _setOptions: function (t) {
            var i = this, s = {}, n = !1;
            ...
            var t, e, i, s = this.options, n = this.uiDialog.is(":visible");
            this.element.show().css({
                ...
                height: "auto",
                width: s.width
            }).height(), e = Math.max(0, s.minHeight - t), "auto" === s.height ? a.support.minHeight ? this.element.css({
                minHeight: e,
                height: "auto"
        ...
        version: "1.8.22", uuid: 0, maxZ: 0, getTitleId: function (t) {
            var e = t.attr("id");
    ...
    g.ui = g.ui || {};
    var i = /left|center|right/, s = /top|center|bottom/, m = "center", v = {}, n = g.fn.position, o = g.fn.offset;
    g.fn.position = function (h) {
        if (!h || !h.of) return n.apply(this, arguments);
        h = g.extend({}, h);
        var c, u, t = g(h.of), e = t[0], d = (h.collision || "flip").split(" "),
            p = h.offset ? h.offset.split(" ") : [0, 0], f = 9 === e.nodeType ? (c = t.width(), u = t.height(), {
                top: 0,
                left: 0
        ...
        return g.each(["my", "at"], function () {
            ...
            var i, t = g(this), s = t.outerWidth(), n = t.outerHeight(),
                ...
                a = n + o + (parseInt(g.curCSS(this, "marginBottom", !0)) || 0), l = g.extend({}, f);
            ...
            }), g.fn.bgiframe && t.bgiframe(), t.offset(g.extend(l, {using: h.using}))
        })
    }, g.ui.position = {
        fit: {
            left: function (t, e) {
                var i = g(window), s = e.collisionPosition.left + e.collisionWidth - i.width() - i.scrollLeft();
                t.left = 0 < s ? t.left - s : Math.max(t.left - e.collisionPosition.left, t.left)
            }, top: function (t, e) {
                var i = g(window), s = e.collisionPosition.top + e.collisionHeight - i.height() - i.scrollTop();
                t.top = 0 < s ? t.top - s : Math.max(t.top - e.collisionPosition.top, t.top)
            }
        }, flip: {
            left: function (t, e) {
                var i, s, n, o, r;
                e.at[0] !== m && (i = g(window), s = e.collisionPosition.left + e.collisionWidth - i.width() - i.scrollLeft(), n = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, o = "left" === e.at[0] ? e.targetWidth : -e.targetWidth, r = -2 * e.offset[0], t.left += e.collisionPosition.left < 0 || 0 < s ? n + o + r : 0)
            }, top: function (t, e) {
                var i, s, n, o, r;
                e.at[1] !== m && (i = g(window), s = e.collisionPosition.top + e.collisionHeight - i.height() - i.scrollTop(), n = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, o = "top" === e.at[1] ? e.targetHeight : -e.targetHeight, r = -2 * e.offset[1], t.top += e.collisionPosition.top < 0 || 0 < s ? n + o + r : 0)
            }
        }
    }, g.offset.setOffset || (g.offset.setOffset = function (t, e) {
        /static/.test(g.curCSS(t, "position")) && (t.style.position = "relative");
        var i = g(t), s = i.offset(), n = parseInt(g.curCSS(t, "top", !0), 10) || 0,
            o = parseInt(g.curCSS(t, "left", !0), 10) || 0, r = {top: e.top - s.top + n, left: e.left - s.left + o};
        ...
        var t, e, i, s = document.getElementsByTagName("body")[0], n = document.createElement("div"),
            o = document.createElement(s ? "div" : "body"),
            r = {visibility: "hidden", width: 0, height: 0, border: 0, margin: 0, background: "none"};
        for (var a in s && g.extend(r, {position: "absolute", left: "-1000px", top: "-1000px"}), r) o.style[a] = r[a];
    ...
    c.widget("ui.slider", c.ui.mouse, {
        ...
        _create: function () {
            var o = this, t = this.options,
                ...
                i = t.values && t.values.length || 1, s = [];
        ...
        _normValueFromMouse: function (t) {
            var e, i, s,
                n = "horizontal" === this.orientation ? (e = this.elementSize.width, t.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left : 0)) : (e = this.elementSize.height, t.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top : 0)),
                o = n / e;
        ...
        _refreshValue: function () {
            var i, s, t, e, n, o = this.options.range, r = this.options, a = this, l = !this._animateOff && r.animate,
                h = {};
            this.options.values && this.options.values.length ? this.handles.each(function (t, e) {
                i = (a.values(t) - a._valueMin()) / (a._valueMax() - a._valueMin()) * 100, h["horizontal" === a.orientation ? "left" : "bottom"] = i + "%", c(this).stop(1, 1)[l ? "animate" : "css"](h, r.animate), !0 === a.options.range && ("horizontal" === a.orientation ? (0 === t && a.range.stop(1, 1)[l ? "animate" : "css"]({left: i + "%"}, r.animate), 1 === t && a.range[l ? "animate" : "css"]({width: i - s + "%"}, {
                    queue: !1,
                    duration: r.animate
                })) : (0 === t && a.range.stop(1, 1)[l ? "animate" : "css"]({bottom: i + "%"}, r.animate), 1 === t && a.range[l ? "animate" : "css"]({height: i - s + "%"}, {
                    queue: !1,
                    duration: r.animate
                }))), s = i
            }) : (t = this.value(), e = this._valueMin(), n = this._valueMax(), i = n !== e ? (t - e) / (n - e) * 100 : 0, h["horizontal" === a.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](h, r.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({width: i + "%"}, r.animate), "max" === o && "horizontal" === this.orientation && this.range[l ? "animate" : "css"]({width: 100 - i + "%"}, {
                queue: !1,
                duration: r.animate
    ...
    p.widget("ui.tabs", {
        options: {
            ...
            this.list = this.element.find("ol,ul").eq(0), this.lis = p(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function () {
                ...
                var i, s, n, o = p(e).attr("href"), r = o.split("#")[0];
                r && (r === location.toString().split("#")[0] || (i = p("base")[0]) && r === i.href) && (o = e.hash, e.href = o), h.test(o) ? a.panels = a.panels.add(a.element.find(a._sanitizeSelector(o))) : o && "#" !== o ? (p.data(e, "href.tabs", o), p.data(e, "load.tabs", o.replace(/#.*$/, "")), s = a._tabId(e), e.href = "#" + s, (n = a.element.find("#" + s)).length || (n = p(l.panelTemplate).attr("id", s).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(a.panels[t - 1] || a.list)).data("destroy.tabs", !0), a.panels = a.panels.add(n)) : l.disabled.push(t)
            ...
            for (var e, s, n, o, r, c = 0; e = this.lis[c]; c++) p(e)[-1 == p.inArray(c, l.disabled) || p(e).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
            ...
            })), l.fx && (p.isArray(l.fx) ? (o = l.fx[0], r = l.fx[1]) : o = r = l.fx);
            var u = r ? function (t, e) {
                p(t).closest("li").addClass("ui-tabs-selected ui-state-active"), e.hide().removeClass("ui-tabs-hide").animate(r, r.duration || "normal", function () {
                    i(e, r), a._trigger("show", null, a._ui(t, e[0]))
                })
            } : function (t, e) {
                ...
                e.animate(o, o.duration || "normal", function () {
                    a.lis.removeClass("ui-tabs-selected ui-state-active"), e.addClass("ui-tabs-hide"), i(e, o), a.element.dequeue("tabs")
                })
            } : function (t, e, i) {
            ...
            this.anchors.bind(l.event + ".tabs", function () {
                var t = this, e = p(t).closest("li"), i = a.panels.filter(":not(.ui-tabs-hide)"),
            ...
            var s = this, n = this.options, o = p(n.tabTemplate.replace(/#\{href\}/g, t).replace(/#\{label\}/g, e)),
            ...
            i = this._getIndex(i);
            var t = this.options, e = this.lis.eq(i).remove(), s = this.panels.eq(i).remove();
            ...
            s = this._getIndex(s);
            var t, n = this, o = this.options, r = this.anchors.eq(s)[0], e = p.data(r, "load.tabs");
            if (this.abort(), e && (0 === this.element.queue("tabs").length || !p.data(r, "cache.tabs"))) return this.lis.eq(s).addClass("ui-state-processing"), o.spinner && (t = p("span", r)).data("label.tabs", t.html()).html(o.spinner), this.xhr = p.ajax(p.extend({}, o.ajaxOptions, {
                url: e,
    ...
    }), p.extend(p.ui.tabs, {version: "1.8.22"}), p.extend(p.ui.tabs.prototype, {
        rotation: null,
        rotate: function (e, t) {
            var i = this, s = this.options, n = i._rotate || (i._rotate = function (t) {
    ...
    var r = 0, l = {}, a = {}, h = Array.prototype.slice, n = "disabled", p = "wizard", f = "default", g = "number",
        m = "boolean";
    u.each("branch form header step wrapper".split(" "), function () {
        ...
        options: {
            animations: {
                show: {options: {duration: 300}, properties: {opacity: "show"}},
                hide: {options: {duration: 30}, properties: {opacity: "hide"}}
            },
            backward: ".backward",
            branches: ".branch",
            disabled: !1,
        ...
        _create: function () {
            var t, e, i = this, s = i.options, n = i.element, o = n.find(s.steps).eq(0).parent();
        ...
        _fastForward: function (s, n, o) {
            var r = 0, a = this, l = a._currentState.stepIndex, h = [l];
            u.isFunction(n) && (o = n, n = c), function i() {
        ...
        _find: function (t, e, i) {
            var s, n, o, r, a, l = [], h = e instanceof jQuery ? e : u(e);

            function c(t, e) {
                if (e === r) return s = e, !1
            }

            if (null !== t && h.length) for (n = 0, o = (t = d(t)).length; n < o; n++) s = null, (a = typeof (r = t[n])) == g ? s = h.get(r) : "string" == a ? s = document.getElementById(r.replace("#", "")) : "object" == a && (r instanceof jQuery && r.length && (r = r[0]), r.nodeType && h.each(c)), s && l.push(s);
            return !1 === i ? l : u(l)
        },
        _move: function (t, e, i, s, n) {
            var o = this, r = o._currentState;
        ...
        _transition: function (t, e, i) {
            ...
            var n = s.options, o = s.step(t, e), r = o.attr(n.stateAttribute),
                a = r ? n.transitions[r] : n.transitions[f], l = u.isFunction(a) ? a.call(s, o, function () {
                    return i.apply(s, h.call(arguments))
                }) : r;
            return l !== c && !1 !== l && i.apply(s, d(l)), l
        },
        _update: function (t, e) {
            var i = this._currentState, s = this.options;
            if (i.step) {
    ...
    h.extend(h.fn, {
        validate: function (t) {
            ...
            var t = !0, e = h(this[0].form).validate();
            return this.each(function () {
                t = t && e.element(this)
            }), t
            ...
            var i = this[0];
            if (t) {
                var s = h.data(i.form, "validator").settings, n = s.rules, o = h.validator.staticRules(i);
                switch (t) {
                    case"add":
            ...
            var a,
                l = h.validator.normalizeRules(h.extend({}, h.validator.classRules(i), h.validator.attributeRules(i), h.validator.dataRules(i), h.validator.staticRules(i)), i);
            return l.required && (a = l.required, delete l.required, l = h.extend({required: a}, l)), l
        }
    }), h.extend(h.expr[":"], {
        blank: function (t) {
        ...
        messages: {
            ...
            maxlength: h.validator.format("Debe introducir {0} caracteres."),
            minlength: h.validator.format("Por favor, introduzca al menos {0} caracteres."),
            ...
            min: h.validator.format("Introduzca un valor igual o superior a {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
                ...
                function t(t) {
                    var e = h.data(this[0].form, "validator"), i = "on" + t.type.replace(/^validate/, "");
        ...
        staticRules: function (t) {
            var e = {}, i = h.data(t.form, "validator");
        ...
        methods: {
            required: function (t, e, i) {
                ...
                for (var i = 0, s = 0, n = !1, o = (t = t.replace(/\D/g, "")).length - 1; 0 <= o; o--) {
                    var r = t.charAt(o), s = parseInt(r, 10);
                    n && 9 < (s *= 2) && (s -= 9), i += s, n = !n
                }
                return i % 10 == 0
                ...
                if (this.settings.messages[r.name] || (this.settings.messages[r.name] = {}), a.originalMessage = this.settings.messages[r.name].remote, this.settings.messages[r.name].remote = a.message, t = "string" == typeof t ? {url: t} : t, a.old === o) return a.valid;
                a.old = o;
                var l = this;
                this.startRequest(r);
                var e = {};
                return e[r.name] = o, h.ajax(h.extend(!0, {
                    ...
                    success: function (t) {
                        ...
                        n ? (e = l.formSubmitted, l.prepareElement(r), l.formSubmitted = e, l.successList.push(r), delete l.invalid[r.name], l.showErrors()) : (i = {}, s = t || l.defaultMessage(r, "remote"), i[r.name] = a.message = h.isFunction(s) ? s(o) : s, l.invalid[r.name] = !0, l.showErrors(i)), a.valid = n, l.stopRequest(r, n)
                    }
                }, t)), "pending"
            }
        }
    ...
    function e(t, e) {
        this.el_ = this.isString_(t) ? n.querySelectorAll(t) : [t], this.config_ = [], this.options_ = e, this.selectors_ = [], this.init_(), this.destroy = function () {
    ...
    e.prototype = {
        defaults_: {
            ...
            var s = this;
            s.initEvents_(), s.loop_(function (t, e) {
            ...
            var t = [].slice.call(arguments), i = t[0], s = t.slice(1);
            ...
            var e = 'label[for="' + t.getAttribute("id") + '"]', i = this.el_[this.current_].querySelectorAll(e);
            return 1 < i.length && (i = t.parentNode.querySelectorAll(e)), 1 === i.length && i[0]
        }, getLabelText_: function (t, e) {
            var i = t.textContent.replace("*", "").trim(), s = e.getAttribute("placeholder");
            ...
            for (var i, s, n = this, o = 0; o < n.el_.length; ++o) {
                void 0 === n.selectors_[o] && (s = ":not(" + (i = n.extend_({}, n.defaults_, n.options_, n.el_[o].getAttribute("data-options"))).exclude.split(/[\s,]+/).join("):not(") + ")", n.selectors_[o] = i.transform.replace(/,/g, s + ",") + s, n.config_[o] = i);
                var r = n.el_[o].querySelectorAll(n.selectors_[o]);
                n.current_ = o, "function" == typeof t && t.call(n, n.el_[o], o);
                for (var a = 0; a < r.length; ++a) "function" == typeof e && e.call(n, r[a], o)
            }
        }, onBlur_: function (t) {
            ...
            var e = this.config_[this.current_].prefix, i = t.className.split(" ").filter(function (t) {
            ...
            for (var t = this.el_[this.current_].querySelectorAll(this.selectors_[this.current_]), e = 0; e < t.length; ++e) t[e].parentNode.classList[this.addRemove_("SELECT" === t[e].tagName && "" !== t[e].value)](this.prefixed_("is-active"))
            ...
            void 0 !== e.value && e.value.length && i.classList.add(this.prefixed_("is-active")), null === e.getAttribute("required") && !e.classList.contains(this.config_[this.current_].requiredClass) || i.classList.add(this.prefixed_("is-required")), e.parentNode.insertBefore(i, e), i.appendChild(t), i.appendChild(e)
        }
    }, "function" == typeof define && define.amd ? define([], function () {
        return e
    }) : "object" == typeof module && module.exports ? module.exports = e : t.FloatLabels = e
}(window, document);